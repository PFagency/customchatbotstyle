...
const pe = {}, jt = [], $e = () => {
}, Ka = () => !1, pr = (t) => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && // uppercase letter
(t.charCodeAt(2) > 122 || t.charCodeAt(2) < 97), Ds = (t) => t.startsWith("onUpdate:"), ye = Object.assign, Rs = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, Za = Object.prototype.hasOwnProperty, ie = (t, e) => Za.call(t, e), J = Array.isArray, Kt = (t) => dr(t) === "[object Map]", Kc = (t) => dr(t) === "[object Set]", ne = (t) => typeof t == "function", me = (t) => typeof t == "string", tn = (t) => typeof t == "symbol", de = (t) => t !== null && typeof t == "object", Zc = (t) => (de(t) || ne(t)) && ne(t.then) && ne(t.catch), Wc = Object.prototype.toString, dr = (t) => Wc.call(t), Wa = (t) => dr(t).slice(8, -1), Jc = (t) => dr(t) === "[object Object]", Ls = (t) => me(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, pn = /* @__PURE__ */ Ts(
  // the leading comma is intentional so empty string "" is also included
  ",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"
), gr = (t) => {
  const e = /* @__PURE__ */ Object.create(null);
  return (n) => e[n] || (e[n] = t(n));
}, Ja = /-(\w)/g, Qe = gr((t) => t.replace(Ja, (e, n) => n ? n.toUpperCase() : "")), Ya = /\B([A-Z])/g, Ft = gr(
...
let mo;
const Yc = () => mo || (mo = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function Tn(t) {
  if (J(t)) {
    const e = {};
    for (let n = 0; n < t.length; n++) {
      const r = t[n], s = me(r) ? nl(r) : Tn(r);
      if (s)
        for (const o in s)
          e[o] = s[o];
    }
...
function nl(t) {
  const e = {};
  return t.replace(tl, "").split(Qa).forEach((n) => {
    if (n) {
      const r = n.split(el);
...
const rl = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", sl = /* @__PURE__ */ Ts(rl);
function Xc(t) {
  return !!t || t === "";
}
const vn = (t) => me(t) ? t : t == null ? "" : J(t) || de(t) && (t.toString === Wc || !ne(t.toString)) ? JSON.stringify(t, Qc, 2) : String(t), Qc = (t, e) => e && e.__v_isRef ? Qc(t, e.value) : Kt(e) ? {
...
} : tn(e) ? Pr(e) : de(e) && !J(e) && !Jc(e) ? String(e) : e, Pr = (t, e = "") => {
  var n;
...
class Ns {
  constructor(e, n, r, s) {
    this.fn = e, this.trigger = n, this.scheduler = r, this.active = !0, this.deps = [], this._dirtyLevel = 4, this._trackId = 0, this._runnings = 0, this._shouldSchedule = !1, this._depsLength = 0, cl(this, s);
  }
  get dirty() {
...
function ri(t, e, n) {
  if (e.get(t) !== t._trackId) {
    ...
    r !== e ? (r && ti(r, t), t.deps[t._depsLength++] = e) : t._depsLength++;
  }
}
const ds = [];
function si(t, e, n) {
...
const ul = /* @__PURE__ */ Ts("__proto__,__v_isRef,__isVue"), ci = new Set(
...
class ii {
  ...
  get(e, n, r) {
    ...
    if (n === "__v_isShallow")
      return o;
    if (n === "__v_raw")
      return r === (s ? o ? Al : fi : o ? ui : li).get(e) || // receiver is not the reactive proxy, but has the same prototype
    ...
    return (tn(n) ? ci.has(n) : ul(n)) || (s || Me(e, "get", n), o) ? i : Se(i) ? c && Ls(n) ? i : i.value : de(i) ? s ? Bs(i) : Fs(i) : i;
  }
}
class ai extends ii {
  constructor(e = !1) {
  ...
  has(e, n) {
    ...
    return (!tn(n) || !ci.has(n)) && Me(e, "has", n), r;
  }
  ownKeys(e) {
    return Me(
      e,
...
const dl = /* @__PURE__ */ new ai(), gl = /* @__PURE__ */ new pl(), ml = /* @__PURE__ */ new ai(
  !0
...
const El = {
  ...
  get: /* @__PURE__ */ qs(!0, !1)
}, li = /* @__PURE__ */ new WeakMap(), ui = /* @__PURE__ */ new WeakMap(), fi = /* @__PURE__ */ new WeakMap(), Al = /* @__PURE__ */ new WeakMap();
function Cl(t) {
  switch (t) {
    case "Object":
    case "Array":
...
function Sl(t) {
  return t.__v_skip || !Object.isExtensible(t) ? 0 : Cl(Wa(t));
}
function Fs(t) {
  return Xt(t) ? t : Ps(
    t,
...
class di {
  ...
  get value() {
    const e = ae(this);
    return (!e._cacheable || e.effect.dirty) && _t(e._value, e._value = e.effect.run()) && Wn(e, 4), gi(e), e.effect._dirtyLevel >= 2 && Wn(e, 2), e._value;
  }
  set value(e) {
    this._setter(e);
  }
...
function Dl(t, e, n = !1) {
  let r, s;
  const o = ne(t);
  return o ? (r = t, s = $e) : (r = t.get, s = t.set), new di(r, s, o || !s, n);
}
function gi(t) {
  var e;
  gt && Nt && (t = ae(t), ri(
    Nt,
    (e = t.dep) != null ? e : t.dep = oi(
      () => t.dep = void 0,
      t instanceof di ? t : void 0
    )
  ));
}
function Wn(t, e = 4, n) {
...
class Ml {
  ...
  get dep() {
    return ll(ae(this._object), this._key);
  }
}
function Ol(t, e, n) {
  const r = t[e];
  return Se(r) ? r : new Ml(t, e, n);
}
/**
...
function Us(t) {
  ...
  )) && (t.id == null ? Ce.push(t) : Ce.splice(Fl(t.id), 0, t), bi());
}
function bi() {
  !xn && !ms && (ms = !0, zs = _i.then(yi));
}
function Bl(t) {
...
const En = (t) => t.id == null ? 1 / 0 : t.id, $l = (t, e) => {
  const n = En(t) - En(e);
  if (n === 0) {
    if (t.pre && !e.pre)
      return -1;
...
function yi(t) {
  ...
  try {
    ...
    Je = 0, Ce.length = 0, vi(), xn = !1, zs = null, (Ce.length || Wt.length) && yi();
  }
}
function zl(t, e, ...n) {
  if (t.isUnmounted)
...
function nr(t) {
  const e = ve;
  return ve = t, Ei = t && t.type.__scopeId || null, e;
}
...
function $r(t) {
  ...
  try {
    ...
    _n.length = 0, br(B, t, 1), R = ge(Ue);
  }
  let I = R;
  if (T && _ !== !1) {
    const B = Object.keys(T), { shapeFlag: P } = I;
    B.length && P & 7 && (c && B.some(Ds) && (T = Hl(
      T,
      c
    )), I = bt(I, T));
  }
...
function Gl({ vnode: t, parent: e }, n) {
  for (; e; ) {
    const r = e.subTree;
...
const jl = "components", ki = Symbol.for("v-ndc");
function Kl(t) {
  return me(t) ? Zl(jl, t, !1) || t : t || ki;
}
function Zl(t, e, n = !0, r = !1) {
  const s = ve || ke;
  if (s) {
    const o = s.type;
    {
...
const Yl = Symbol.for("v-scx"), Xl = () => Jt(Yl), zn = {};
function Jn(t, e, n) {
  return wi(t, e, n);
}
function wi(t, e, {
  ...
  if (wr)
    if (m = $e, e ? n && ze(e, a, 3, [
      ...
      return $e;
  let R = h ? new Array(t.length).fill(zn) : zn;
  const T = () => {
    if (!(!I.active || !I.dirty))
      if (e) {
        const y = I.run();
        (r || f || (h ? y.some((W, $) => _t(W, R[$])) : _t(y, R))) && (d && d(), ze(e, a, 3, [
          y,
          // pass undefined as the old value when it's changed for the first time
          R === zn ? void 0 : h && R[0] === zn ? [] : R,
          m
        ]), R = y);
      } else
        I.run();
  ...
  T.allowRecurse = !!e;
  let D;
  s === "sync" ? D = T : s === "post" ? D = () => Ne(T, a && a.suspense) : (T.pre = !0, a && (T.id = a.uid), D = () => Us(T));
  const I = new Ns(u, $e, D), B = ei(), P = () => {
...
function Ql(t, e, n) {
  const r = this.proxy, s = me(t) ? t.includes(".") ? Ai(r, t) : () => r[t] : t.bind(r, r);
  let o;
  ne(e) ? o = e : (o = e.handler, n = e);
  const c = Dn(this), i = wi(s, o.bind(r), n);
  return c(), i;
}
function Ai(t, e) {
  const n = e.split(".");
...
const ut = Symbol("_leaveCb"), Un = Symbol("_enterCb");
function eu() {
  const t = {
    isMounted: !1,
    isLeaving: !1,
...
const Pe = [Function, Array], Si = {
  ...
  setup(t, { slots: e }) {
    const n = Fu(), r = eu();
    return () => {
      const s = e.default && Di(e.default(), !0);
      if (!s || !s.length)
        return;
      let o = s[0];
      if (s.length > 1) {
      ...
      if (f && f.type !== Ue && !Dt(a, f)) {
        ...
        i === "in-out" && a.type !== Ue && (h.delayLeave = (d, m, _) => {
          const R = Ti(
            r,
            f
          );
...
function _s(t, e, n, r) {
  const {
    ...
    const U = Q[1];
    P($, Q), J($) ? $.every((oe) => oe.length <= 1) && U() : $.length <= 1 && U();
  }, W = {
    mode: o,
    persisted: c,
    beforeEnter($) {
    ...
    enter($) {
      ...
      let L = !1;
      const ee = $[Un] = (A) => {
        L || (L = !0, A ? P(oe, [$]) : P(U, [$]), W.delayedLeave && W.delayedLeave(), $[Un] = void 0);
      };
      Q ? y(Q, [$, ee]) : ee();
    },
    leave($, Q) {
      ...
      let oe = !1;
      const L = $[ut] = (ee) => {
        oe || (oe = !0, Q(), ee ? P(m, [$]) : P(d, [$]), $[ut] = void 0, B[U] === t && delete B[U]);
      };
      B[U] = t, h ? y(h, [$, L]) : L();
    },
    clone($) {
...
function Di(t, e = !1, n) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    c.type === Ae ? (c.patchFlag & 128 && s++, r = r.concat(
      Di(c.children, e, i)
    )) : (e || c.type !== Ue) && r.push(i != null ? bt(c, { key: i }) : c);
  }
  if (s > 1)
...
function Ri(t, e, n = ke) {
  ...
  if (xr(e, r, n), n) {
    let s = n.parent;
    for (; s && s.parent; )
      yr(s.parent.vnode) && ou(r, e, n, s), s = s.parent;
  }
}
function ou(t, e, n, r) {
  const s = xr(
...
), cu = ot("bm"), vt = ot("m"), iu = ot("bu"), au = ot("u"), Hs = ot("bum"), Vs = ot("um"), lu = ot("sp"), uu = ot(
  "rtg"
), fu = ot(
  "rtc"
);
...
function Li(t) {
  return t.some((e) => or(e) ? !(e.type === Ue || e.type === Ae && !Li(e.children)) : !0) ? t : null;
}
const vs = (t) => t ? Vi(t) ? Ar(t) || t.proxy : vs(t.parent) : null, gn = (
  ...
  /* @__PURE__ */ ye(/* @__PURE__ */ Object.create(null), {
    ...
    $forceUpdate: (t) => t.f || (t.f = () => {
      t.effect.dirty = !0, Us(t.update);
    }),
    $nextTick: (t) => t.n || (t.n = Qt.bind(t.proxy)),
    $watch: (t) => Ql.bind(t)
  })
), Ur = (t, e) => t !== pe && !t.__isScriptSetup && ie(t, e), pu = {
  get({ _: t }, e) {
  ...
  set({ _: t }, e, n) {
    ...
    return Ur(s, e) ? (s[e] = n, !0) : r !== pe && ie(r, e) ? (r[e] = n, !0) : ie(t.props, e) || e[0] === "$" && e.slice(1) in t ? !1 : (o[e] = n, !0);
  },
  has({
    _: { data: t, setupState: e, accessCache: n, ctx: r, appContext: s, propsOptions: o }
  }, c) {
    let i;
    return !!n[c] || t !== pe && ie(t, c) || Ur(e, c) || (i = o[0]) && ie(i, c) || ie(r, c) || ie(gn, c) || ie(s.config.globalProperties, c);
  },
...
function du(t) {
  ...
  if (F(cu, f), F(vt, h), F(iu, d), F(au, m), F(ru, _), F(su, R), F(hu, $), F(fu, y), F(uu, W), F(Hs, D), F(Vs, B), F(lu, Q), J(U))
    if (U.length) {
...
function yu(t, e) {
  return function(r, s = null) {
    ...
    const o = Ii(), c = /* @__PURE__ */ new WeakSet();
    let i = !1;
    const a = o.app = {
      _uid: vu++,
      _component: r,
...
function Eu(t, e, n, r = !1) {
  const s = {}, o = {};
  Qn(o, kr, 1), t.propsDefaults = /* @__PURE__ */ Object.create(null), Mi(t, e, s, o);
  for (const c in t.propsOptions[0])
    c in s || (s[c] = void 0);
  n ? t.props = r ? s : Tl(s) : t.type.props ? t.props = s : t.props = o, t.attrs = o;
}
function ku(t, e, n, r) {
  const {
    props: s,
...
const qi = (t) => t[0] === "_" || t === "$stable", js = (t) => J(t) ? t.map(We) : [We(t)], wu = (t, e, n) => {
  if (e._n)
    return e;
  ...
  if (r.shapeFlag & 32) {
    const i = e._;
    i ? n && i === 1 ? o = !1 : (ye(s, e), !n && i === 1 && delete s._) : (o = !e.$stable, Fi(e, s)), c = e;
  } else
    e && (Bi(t, e), c = { default: 1 });
  if (o)
    for (const i in s)
      !qi(i) && c[i] == null && delete s[i];
};
...
function Tu(t, e) {
  ...
  const {
    ...
    const { type: x, ref: z, shapeFlag: V } = g;
    switch (x) {
      case Er:
        R(p, g, b, k);
        break;
    ...
    let N, x;
    const { props: z, shapeFlag: V, transition: G, dirs: Y } = p;
    if (N = p.el = c(
      p.type,
      O,
      z && z.is,
      ...
      E,
      M
    ), Y && kt(p, null, k, "created"), W(N, p, p.scopeId, E, k), z) {
      for (const q in z)
        q !== "value" && !pn(q) && o(
          N,
          q,
      ...
      "value" in z && o(N, "value", null, z.value, O), (x = z.onVnodeBeforeMount) && Ze(x, k, p);
    }
    Y && kt(p, null, k, "beforeMount");
    const w = Du(S, G);
    w && G.beforeEnter(N), r(N, g, b), ((x = z && z.onVnodeMounted) || w || Y) && Ne(() => {
    ...
    const M = g.el = p.el;
    let { patchFlag: N, dynamicChildren: x, dirs: z } = g;
    N |= p.patchFlag & 16;
    const V = p.props || pe, G = g.props || pe;
    let Y;
    if (b && wt(b, !1), (Y = G.onVnodeBeforeUpdate) && Ze(Y, b, g, p), z && kt(g, p, b, "beforeUpdate"), b && wt(b, !0), x ? U(
      p.dynamicChildren,
      x,
      M,
      b,
    ...
    ((Y = G.onVnodeUpdated) || z) && Ne(() => {
      Y && Ze(Y, b, g, p), z && kt(g, p, b, "updated");
    }, k);
  }, U = (p, g, b, k, S, O, E) => {
    ...
    const x = g.el = p ? p.el : i(""), z = g.anchor = p ? p.anchor : i("");
    let { patchFlag: V, dynamicChildren: G, slotScopeIds: Y } = g;
    Y && (M = M ? M.concat(Y) : Y), p == null ? (r(x, b, k), r(z, b, k), $(
      // #10007
    ...
    const M = p.component = qu(
      p,
      k,
      S
    );
    if (yr(p) && (M.ctx.renderer = xt), Bu(M), M.asyncDep) {
      if (S && S.registerDep(M, F), !p.el) {
        const N = M.subTree = ge(Ue);
        T(null, N, g, b);
      }
    } else
      F(
    ...
    if (Vl(p, g, b))
      if (k.asyncDep && !k.asyncResolved) {
        ...
        k.next = g, Bl(k.update), k.effect.dirty = !0, k.update();
    else
      g.el = p.el, k.vnode = g;
  }, F = (p, g, b, k, S, O, E) => {
    const M = () => {
      if (p.isMounted) {
        let { next: z, bu: V, u: G, parent: Y, vnode: w } = p;
        {
          const we = $i(p);
          if (we) {
            z && (z.el = w.el, v(p, z, E)), we.asyncDep.then(() => {
              p.isUnmounted || M();
            });
            return;
          }
        ...
        let q = z, H;
        wt(p, !1), z ? (z.el = w.el, v(p, z, E)) : z = w, V && Zn(V), (H = z.props && z.props.onVnodeBeforeUpdate) && Ze(H, Y, z, w), wt(p, !0);
        ...
        p.subTree = X, _(
          ...
          S,
          O
        ), z.el = X.el, q === null && Gl(p, X.el), G && Ne(G, S), (H = z.props && z.props.onVnodeUpdated) && Ne(
          () => Ze(H, Y, z, w),
          S
        );
      } else {
        ...
        if (wt(p, !1), Y && Zn(Y), !H && (z = G && G.onVnodeBeforeMount) && Ze(z, q, g), wt(p, !0), V && Mn) {
          const X = () => {
            p.subTree = $r(p), Mn(
              V,
              p.subTree,
        ...
        if (w && Ne(w, S), !H && (z = G && G.onVnodeMounted)) {
          const X = g;
          Ne(
            () => Ze(z, q, X),
            S
    ...
    p.vnode = g, p.next = null, ku(p, g.props, k, b), Cu(p, g.children, b), Bt(), wo(p), Pt();
  }, C = (p, g, b, k, S, O, E, M, N = !1) => {
    const x = p && p.children, z = p ? p.shapeFlag : 0, V = g.children, { patchFlag: G, shapeFlag: Y } = g;
    if (G > 0) {
      if (G & 128) {
        te(
          x,
    ...
    Y & 8 ? (z & 16 && _e(x, S, O), V !== x && u(b, V)) : z & 16 ? Y & 16 ? te(
      x,
      V,
      b,
      k,
    ...
    p = p || jt, g = g || jt;
    const x = p.length, z = g.length, V = Math.min(x, z);
    let G;
    for (G = 0; G < V; G++) {
    ...
    if (x > V) {
      ...
      const po = we ? Ru(Et) : jt;
      for (H = po.length - 1, x = fe - 1; x >= 0; x--) {
        const Oe = w + x, Ke = g[Oe], go = Oe + 1 < z ? g[Oe + 1].el : k;
        Et[x] === 0 ? _(
          null,
          Ke,
          b,
    ...
    if (M != null && ks(M, null, b, p, !0), z & 256) {
      g.ctx.deactivate(p);
      return;
    }
    const Y = z & 1 && G, w = !dn(p);
    let q;
    if (w && (q = E && E.onVnodeBeforeUnmount) && Ze(q, g, p), z & 6)
      Te(p.component, b, k);
    else {
      if (z & 128) {
      ...
      Y && kt(p, null, g, "beforeUnmount"), z & 64 ? p.type.remove(
        p,
        g,
        b,
        S,
      ...
      (O !== Ae || V > 0 && V & 64) ? _e(
        ...
        !1,
        !0
      ) : (O === Ae && V & 384 || !S && z & 16) && _e(N, g, b), k && xe(p);
    }
...
function Pi(t, e, n = !1) {
  ...
  if (J(r) && J(s))
    for (let o = 0; o < r.length; o++) {
      const c = r[o];
      let i = s[o];
      i.shapeFlag & 1 && !i.dynamicChildren && ((i.patchFlag <= 0 || i.patchFlag === 32) && (i = s[o] = ft(s[o]), i.el = c.el), n || Pi(c, i)), i.type === Er && (i.el = c.el);
    }
}
function Ru(t) {
  const e = t.slice(), n = [0];
...
const Lu = (t) => t.__isTeleport, Ae = Symbol.for("v-fgt"), Er = Symbol.for("v-txt"), Ue = Symbol.for("v-cmt"), Vr = Symbol.for("v-stc"), _n = [];
let Ge = null;
function Z(t = !1) {
  _n.push(Ge = t ? null : []);
}
...
function zi(t) {
  return t.dynamicChildren = kn > 0 ? Ge || jt : null, Nu(), kn > 0 && Ge && Ge.push(t), t;
}
...
const kr = "__vInternal", Ui = ({ key: t }) => t ?? null, Yn = ({
  ref: t,
  ref_key: e,
  ref_for: n
...
const ge = Iu;
function Iu(t, e = null, n = null, r = 0, s = null, o = !1) {
  if ((!t || t === ki) && (t = Ue), or(t)) {
    const i = bt(
      t,
      e,
  ...
  if (Hu(t) && (t = t.__vccOpts), e) {
    ...
    i && !me(i) && (e.class = nn(i)), de(a) && (hi(a) && !J(a) && (a = ye({}, a)), e.style = Tn(a));
  }
  const c = me(t) ? 1 : Wl(t) ? 128 : Lu(t) ? 64 : de(t) ? 4 : ne(t) ? 2 : 0;
  return he(
    t,
    e,
    n,
...
function Ks(t) {
  return t ? hi(t) || kr in t ? ye({}, t) : t : null;
}
function bt(t, e, n = !1) {
  const { props: r, ref: s, patchFlag: o, children: c } = t, i = e ? Hi(r || {}, e) : r;
  return {
    __v_isVNode: !0,
    __v_skip: !0,
    type: t.type,
...
function Fe(t = "", e = !1) {
  return e ? (Z(), be(Ue, null, t)) : ge(Ue, null, t);
}
function We(t) {
  return t == null || typeof t == "boolean" ? ge(Ue) : J(t) ? ge(
    Ae,
    null,
...
let Ou = 0;
function qu(t, e, n) {
  const r = t.type, s = (e ? e.appContext : t.appContext) || Mu, o = {
    uid: Ou++,
    vnode: t,
    type: r,
    parent: e,
...
function Bu(t, e = !1) {
  e && ws(e);
  const { props: n, children: r } = t.vnode, s = Vi(t);
  Eu(t, n, s, e), Au(t, r);
  const o = s ? Pu(t, e) : void 0;
  return e && ws(!1), o;
}
function Pu(t, e) {
  const n = t.type;
  t.accessCache = /* @__PURE__ */ Object.create(null), t.proxy = pi(new Proxy(t.ctx, pu));
  const { setup: r } = n;
  if (r) {
...
function Bo(t, e, n) {
  ne(e) ? t.type.__ssrInlineRender ? t.ssrRender = e : t.render = e : de(e) && (t.setupState = mi(e)), Gi(t, n);
}
let Po;
function Gi(t, e, n) {
  const r = t.type;
...
function Ar(t) {
  if (t.exposed)
    return t.exposeProxy || (t.exposeProxy = new Proxy(mi(pi(t.exposed)), {
      get(e, n) {
        if (n in e)
          return e[n];
        if (n in gn)
...
* @license MIT
**/
const Gu = "http://www.w3.org/2000/svg", ju = "http://www.w3.org/1998/Math/MathML", ht = typeof document < "u" ? document : null, $o = ht && /* @__PURE__ */ ht.createElement("template"), Ku = {
  insert: (t, e, n) => {
  ...
  createElement: (t, e, n, r) => {
    const s = e === "svg" ? ht.createElementNS(Gu, t) : e === "mathml" ? ht.createElementNS(ju, t) : ht.createElement(t, n ? { is: n } : void 0);
...
}, it = "transition", an = "animation", wn = Symbol("_vtc"), ir = (t, { slots: e }) => ji(nu, Zu(t), e);
...
}, zo = (t) => t ? J(t) ? t.some((e) => e.length > 1) : t.length > 1 : !1;
function Zu(t) {
  const e = {};
  for (const L in t)
    L in Ki || (e[L] = t[L]);
  ...
  const {
    ...
    At(K, [ee, F]), Uo(() => {
      Ct(ee, L ? a : o), at(ee, L ? u : i), zo(K) || Ho(ee, r, _, F);
    });
  };
  return ye(e, {
    onBeforeEnter(L) {
    ...
    onLeave(L, ee) {
      ...
      const A = () => U(L, ee);
      at(L, f), Xu(), at(L, h), Uo(() => {
        L._isLeaving && (Ct(L, f), at(L, d), zo(B) || Ho(L, r, R, A));
      }), At(B, [L, A]);
    },
    onEnterCancelled(L) {
      Q(L, !1), At(I, [L]);
...
let Ju = 0;
function Ho(t, e, n, r) {
  const s = t._endId = ++Ju, o = () => {
    s === t._endId && r();
  };
  if (n)
    return setTimeout(o, n);
  const { type: c, timeout: i, propCount: a } = Yu(t, e);
  if (!c)
    return r();
  const l = c + "end";
  let u = 0;
...
const ar = Symbol("_vod"), Zi = Symbol("_vsh"), ef = {
...
function ln(t, e) {
  t.style.display = e ? t[ar] : "none", t[Zi] = !e;
}
...
function rf(t, e, n) {
  ...
  if (n && !s) {
    ...
    if (e !== n) {
      const c = r[tf];
      c && (n += ";" + c), r.cssText = n, o = nf.test(n);
    }
  } else
    e && t.removeAttribute("style");
  ar in t && (t[ar] = o ? r.display : "", t[Zi] && (r.display = "none"));
}
...
function of(t, e, n, r, s) {
  if (r && e.startsWith("xlink:"))
    ...
    const o = sl(e);
    n == null || o && !Xc(n) ? t.removeAttribute(e) : t.setAttribute(e, o ? "" : n);
  }
}
function cf(t, e, n, r, s, o, c) {
  ...
  if (n === "" || n == null) {
    const l = typeof t[e];
    l === "boolean" ? n = Xc(n) : n == null && l === "string" ? (n = "", a = !0) : l === "number" && (n = 0, a = !0);
  }
  try {
    t[e] = n;
  } catch {
...
let Kr = 0;
const ff = /* @__PURE__ */ Promise.resolve(), hf = () => Kr || (ff.then(() => Kr = 0), Kr = Date.now());
function pf(t, e) {
  const n = (r) => {
    if (!r._vts)
      r._vts = Date.now();
  ...
  return n.value = t, n.attached = hf(), n;
}
function df(t, e) {
  if (J(e)) {
...
t.charCodeAt(2) > 96 && t.charCodeAt(2) < 123, gf = (t, e, n, r, s, o, c, i, a) => {
  const l = s === "svg";
  e === "class" ? Qu(t, r, l) : e === "style" ? rf(t, n, r) : pr(e) ? Ds(e) || lf(t, e, n, r, c) : (e[0] === "." ? (e = e.slice(1), !0) : e[0] === "^" ? (e = e.slice(1), !1) : mf(t, e, r, l)) ? cf(
    t,
    e,
    r,
    o,
    ...
    i,
    a
  ) : (e === "true-value" ? t._trueValue = r : e === "false-value" && (t._falseValue = r), of(t, e, r, l));
};
function mf(t, e, n, r) {
  if (r)
...
const Zr = Symbol("_assign"), bf = {
  created(t, { modifiers: { lazy: e, trim: n, number: r } }, s) {
    ...
    }), e || (Gt(t, "compositionstart", _f), Gt(t, "compositionend", Qo), Gt(t, "change", Qo));
  },
  ...
  return n[r] || (n[r] = (s) => {
    if (!("key" in s))
      return;
    const o = Ft(s.key);
    if (e.some((c) => c === o || Ef[c] === o))
      return t(s);
  });
}, wf = /* @__PURE__ */ ye({ patchProp: gf }, Ku);
let ec;
function Af() {
  return ec || (ec = Su(wf));
}
const Cf = (...t) => {
  const e = Af().createApp(...t), { mount: n } = e;
  return e.mount = (r) => {
    const s = Tf(r);
    if (!s)
      return;
...
function Wi(t) {
  return t instanceof Map ? t.clear = t.delete = t.set = function() {
    ...
    (r === "object" || r === "function") && !Object.isFrozen(n) && Wi(n);
  }), t;
}
class tc {
  /**
...
const Rf = "</span>", nc = (t) => !!t.scope, Lf = (t, { prefix: e }) => {
...
class Ys {
  constructor() {
    this.rootNode = rc(), this.stack = [this.rootNode];
  }
  get top() {
...
class If extends Ys {
  ...
  toHTML() {
    return new Nf(this, this.options).value();
  }
  finalize() {
...
function Xs(...t) {
  return "(" + (qf(t).capture ? "" : "?:") + t.map((r) => An(r)).join("|") + ")";
}
function Xi(t) {
...
const Pf = /\b\B/, Qi = "[a-zA-Z]\\w*", eo = "[a-zA-Z_]\\w*", ea = "\\b\\d+(\\.\\d+)?", ta = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", na = "\\b(0b[01]+)", $f = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", zf = (t = {}) => {
  const e = /^#![ ]*\//;
...
var Hn = /* @__PURE__ */ Object.freeze({
  ...
  C_NUMBER_MODE: Wf,
  C_NUMBER_RE: ta,
  END_SAME_AS_BEGIN: th,
  HASH_COMMENT_MODE: Kf,
  IDENT_RE: Qi,
  MATCH_NOTHING_RE: Pf,
  METHOD_GUARD: eh,
  NUMBER_MODE: Zf,
  NUMBER_RE: ea,
  PHRASAL_WORDS_MODE: Vf,
  QUOTE_STRING_MODE: Hf,
  REGEXP_MODE: Yf,
  RE_STARTERS_RE: $f,
  SHEBANG: zf,
  TITLE_MODE: Xf,
  UNDERSCORE_IDENT_RE: eo,
  UNDERSCORE_TITLE_MODE: Qf
});
function nh(t, e) {
...
function sh(t, e) {
  e && t.beginKeywords && (t.begin = "\\b(" + t.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)", t.__beforeBegin = nh, t.keywords = t.keywords || t.beginKeywords, delete t.beginKeywords, t.relevance === void 0 && (t.relevance = 0));
}
function oh(t, e) {
  Array.isArray(t.illegal) && (t.illegal = Xs(...t.illegal));
}
function ch(t, e) {
  if (t.match) {
    if (t.begin || t.end)
...
const ah = (t, e) => {
  ...
  Object.keys(t).forEach((r) => {
    delete t[r];
  }), t.keywords = n.keywords, t.begin = $t(n.beforeMatch, Yi(n.begin)), t.starts = {
    relevance: 0,
    contains: [
...
function fh(t, e) {
  return e ? Number(e) : hh(t) ? 0 : 1;
}
function hh(t) {
  return lh.includes(t.toLowerCase());
}
const sc = {}, Ot = (t) => {
  console.error(t);
}, oc = (t, ...e) => {
  ...
  sc[`${t}/${e}`] || (console.log(`Deprecated as of ${t}. ${e}`), sc[`${t}/${e}`] = !0);
}, lr = new Error();
function sa(t, e, { key: n }) {
  let r = 0;
  const s = t[n], o = {}, c = {};
  for (let i = 1; i <= e.length; i++)
    c[i + r] = s[i], o[i + r] = !0, r += Xi(e[i - 1]);
...
function ph(t) {
  if (Array.isArray(t.begin)) {
    ...
    sa(t, t.begin, { key: "beginScope" }), t.begin = Qs(t.begin, { joinWith: "" });
  }
}
function dh(t) {
  if (Array.isArray(t.end)) {
    ...
    sa(t, t.end, { key: "endScope" }), t.end = Qs(t.end, { joinWith: "" });
  }
}
function gh(t) {
...
function mh(t) {
  gh(t), typeof t.beginScope == "string" && (t.beginScope = { _wrap: t.beginScope }), typeof t.endScope == "string" && (t.endScope = { _wrap: t.endScope }), ph(t), dh(t);
}
function _h(t) {
  function e(c, i) {
    return new RegExp(
  ...
  class n {
    ...
    // @ts-ignore
    addRule(i, a) {
      a.position = this.position++, this.matchIndexes[this.matchAt] = a, this.regexes.push([a, i]), this.matchAt += Xi(i) + 1;
    }
    compile() {
      this.regexes.length === 0 && (this.exec = () => null);
      const i = this.regexes.map((a) => a[1]);
      this.matcherRe = e(Qs(i, { joinWith: "|" }), !0), this.lastIndex = 0;
    }
    /** @param {string} s */
    exec(i) {
...
function oa(t) {
  return t ? t.endsWithParent || oa(t.starts) : !1;
}
function bh(t) {
  return t.variants && !t.cachedVariants && (t.cachedVariants = t.variants.map(function(e) {
    return dt(t, { variants: null }, e);
  })), t.cachedVariants ? t.cachedVariants : oa(t) ? dt(t, { starts: t.starts ? dt(t.starts) : null }) : Object.isFrozen(t) ? dt(t) : t;
}
var vh = "11.9.0";
...
const Wr = Ji, cc = dt, ic = Symbol("nomatch"), xh = 7, ca = function(t) {
  ...
  function l(v) {
    ...
    if (j) {
      const te = Q(j[1]);
      return te || (oc(o.replace("{}", j[1])), oc("Falling back to no-highlight mode for this block.", v)), te ? j[1] : "no-highlight";
    }
...
https://github.com/highlightjs/highlight.js/issues/2277`), re = v, te = C), j === void 0 && (j = !0);
  ...
  function f(v, C, j, te) {
    ...
    function xe() {
      ...
      for (; q; ) {
        ...
        if (fe) {
          const [we, On] = fe;
          if (N.addText(H), H = "", re[X] = (re[X] || 0) + 1, re[X] <= xh && (z += On), we.startsWith("_"))
            H += q[0];
          else {
    ...
    function zt() {
      ...
      E.relevance > 0 && (z += w.relevance), N.__addSublanguage(w._emitter, w.language);
    }
    function Te() {
      E.subLanguage != null ? zt() : xe(), x = "";
    }
    function _e(w, q) {
    ...
    function In(w) {
      const q = w[0], H = w.rule, X = new tc(H), fe = [H.__beforeBegin, H["on:begin"]];
      for (const we of fe)
        if (we && (we(w, X), X.isMatchIgnored))
          return xt(q);
      return H.skip ? x += q : (H.excludeBegin && (x += q), Te(), !H.returnBegin && !H.excludeBegin && (x = q)), Ut(H, w), H.returnBegin ? 0 : q.length;
    }
    function Mn(w) {
      ...
      do
        E.scope && N.closeNode(), !E.skip && !E.subLanguage && (z += E.relevance), E = E.parent;
      while (E !== X.parent);
      return X.starts && Ut(X.starts, w), fe.returnEnd ? 0 : q.length;
    }
    function p() {
      const w = [];
  ...
  function y(v, C) {
    ...
    j.name || (j.name = v), e[v] = j, j.rawDefinition = C.bind(null, t), j.aliases && U(j.aliases, { languageName: v });
  }
  function W(v) {
    delete e[v];
  ...
  for (const v in Hn)
    typeof Hn[v] == "object" && Wi(Hn[v]);
  return Object.assign(t, Hn), t;
}, en = ca({});
en.newInstance = () => ca({});
var Eh = en;
en.HighlightJS = en;
en.default = en;
const nt = /* @__PURE__ */ Js(Eh);
function ia(t) {
...
const ac = "[A-Za-z$_][0-9A-Za-z$_]*", kh = [
  "as",
  // for exports
  "in",
  "of",
...
const Sr = (t, e) => {
  ...
  for (const [r, s] of e)
    n[r] = s;
  return n;
}, Sh = {}, Th = { class: "chat-button" };
function Dh(t, e) {
  return Z(), ce("button", Th, [
    Mt(t.$slots, "default")
  ]);
}
const Rh = /* @__PURE__ */ Sr(Sh, [["render", Dh]]), Lh = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, Nh = /* @__PURE__ */ he("path", {
...
function Mh(t, e) {
  return Z(), ce("svg", Lh, [...Ih]);
}
const Oh = { name: "mdi-close", render: Mh };
function qh() {
...
const Ie = qh(), Bh = { class: "chat-layout" }, Ph = {
  key: 0,
  class: "chat-header"
}, $h = {
  key: 2,
  ...
  defaultLanguage: "en",
  showWelcomeScreen: !1,
  initialMessages: ["Welcome!", "Lia - Linkedin Expert"],
  i18n: {
    en: {
      title: "Hello!",
      subtitle: "Select the Language you want to communicate",
      footer: "",
  ...
  theme: {}
}, Uh = "#n8n-chat", Hh = "n8n-chat", lc = `${Hh}/sessionId`, ha = "Chat", pa = "ChatOptions";
function to() {
  return Jt(ha);
}
function Rn() {
...
const Vh = { class: "chat-get-started" }, Gh = /* @__PURE__ */ Ve({
  __name: "GetStarted",
  setup(t) {
    const { t: e } = Tr();
    return (n, r) => (Z(), ce("div", Vh, [
      ge(Rh, {
...
}), jh = {}, Kh = { class: "chat-powered-by" }, Zh = /* @__PURE__ */ he("a", { href: "https://n8n.io?utm_source=n8n-external&utm_medium=widget-powered-by" }, "n8n", -1);
function Wh(t, e) {
  return Z(), ce("div", Kh, [
    Zs(" Powered by "),
    Zh
...
const Jh = /* @__PURE__ */ Sr(jh, [["render", Wh]]), Yh = { class: "chat-get-started-footer" }, Xh = { key: 0 }, Qh = /* @__PURE__ */ Ve({
  __name: "GetStartedFooter",
  setup(t) {
    const { t: e, te: n } = Tr();
    return (r, s) => (Z(), ce("div", Yh, [
      se(n)("footer") ? (Z(), ce("div", Xh, vn(se(e)("footer")), 1)) : Fe("", !0),
      ge(Jh)
    ]));
  }
});
var le = {};
const ep = "Á", tp = "á", np = "Ă", rp = "ă", sp = "∾", op = "∿", cp = "∾̳", ip = "Â", ap = "â", lp = "´", up = "А", fp = "а", hp = "Æ", pp = "æ", dp = "⁡", gp = "𝔄", mp = "𝔞", _p = "À", bp = "à", vp = "ℵ", yp = "ℵ", xp = "Α", Ep = "α", kp = "Ā", wp = "ā", Ap = "⨿", Cp = "&", Sp = "&", Tp = "⩕", Dp = "⩓", Rp = "∧", Lp = "⩜", Np = "⩘", Ip = "⩚", Mp = "∠", Op = "⦤", qp = "∠", Fp = "⦨", Bp = "⦩", Pp = "⦪", $p = "⦫", zp = "⦬", Up = "⦭", Hp = "⦮", Vp = "⦯", Gp = "∡", jp = "∟", Kp = "⊾", Zp = "⦝", Wp = "∢", Jp = "Å", Yp = "⍼", Xp = "Ą", Qp = "ą", ed = "𝔸", td = "𝕒", nd = "⩯", rd = "≈", sd = "⩰", od = "≊", cd = "≋", id = "'", ad = "⁡", ld = "≈", ud = "≊", fd = "Å", hd = "å", pd = "𝒜", dd = "𝒶", gd = "≔", md = "*", _d = "≈", bd = "≍", vd = "Ã", yd = "ã", xd = "Ä", Ed = "ä", kd = "∳", wd = "⨑", Ad = "≌", Cd = "϶", Sd = "‵", Td = "∽", Dd = "⋍", Rd = "∖", Ld = "⫧", Nd = "⊽", Id = "⌅", Md = "⌆", Od = "⌅", qd = "⎵", Fd = "⎶", Bd = "≌", Pd = "Б", $d = "б", zd = "„", Ud = "∵", Hd = "∵", Vd = "∵", Gd = "⦰", jd = "϶", Kd = "ℬ", Zd = "ℬ", Wd = "Β", Jd = "β", Yd = "ℶ", Xd = "≬", Qd = "𝔅", eg = "𝔟", tg = "⋂", ng = "◯", rg = "⋃", sg = "⨀", og = "⨁", cg = "⨂", ig = "⨆", ag = "★", lg = "▽", ug = "△", fg = "⨄", hg = "⋁", pg = "⋀", dg = "⤍", gg = "⧫", mg = "▪", _g = "▴", bg = "▾", vg = "◂", yg = "▸", xg = "␣", Eg = "▒", kg = "░", wg = "▓", Ag = "█", Cg = "=⃥", Sg = "≡⃥", Tg = "⫭", Dg = "⌐", Rg = "𝔹", Lg = "𝕓", Ng = "⊥", Ig = "⊥", Mg = "⋈", Og = "⧉", qg = "┐", Fg = "╕", Bg = "╖", Pg = "╗", $g = "┌", zg = "╒", Ug = "╓", Hg = "╔", Vg = "─", Gg = "═", jg = "┬", Kg = "╤", Zg = "╥", Wg = "╦", Jg = "┴", Yg = "╧", Xg = "╨", Qg = "╩", em = "⊟", tm = "⊞", nm = "⊠", rm = "┘", sm = "╛", om = "╜", cm = "╝", im = "└", am = "╘", lm = "╙", um = "╚", fm = "│", hm = "║", pm = "┼", dm = "╪", gm = "╫", mm = "╬", _m = "┤", bm = "╡", vm = "╢", ym = "╣", xm = "├", Em = "╞", km = "╟", wm = "╠", Am = "‵", Cm = "˘", Sm = "˘", Tm = "¦", Dm = "𝒷", Rm = "ℬ", Lm = "⁏", Nm = "∽", Im = "⋍", Mm = "⧅", Om = "\\", qm = "⟈", Fm = "•", Bm = "•", Pm = "≎", $m = "⪮", zm = "≏", Um = "≎", Hm = "≏", Vm = "Ć", Gm = "ć", jm = "⩄", Km = "⩉", Zm = "⩋", Wm = "∩", Jm = "⋒", Ym = "⩇", Xm = "⩀", Qm = "ⅅ", e_ = "∩︀", t_ = "⁁", n_ = "ˇ", r_ = "ℭ", s_ = "⩍", o_ = "Č", c_ = "č", i_ = "Ç", a_ = "ç", l_ = "Ĉ", u_ = "ĉ", f_ = "∰", h_ = "⩌", p_ = "⩐", d_ = "Ċ", g_ = "ċ", m_ = "¸", __ = "¸", b_ = "⦲", v_ = "¢", y_ = "·", x_ = "·", E_ = "𝔠", k_ = "ℭ", w_ = "Ч", A_ = "ч", C_ = "✓", S_ = "✓", T_ = "Χ", D_ = "χ", R_ = "ˆ", L_ = "≗", N_ = "↺", I_ = "↻", M_ = "⊛", O_ = "⊚", q_ = "⊝", F_ = "⊙", B_ = "®", P_ = "Ⓢ", $_ = "⊖", z_ = "⊕", U_ = "⊗", H_ = "○", V_ = "⧃", G_ = "≗", j_ = "⨐", K_ = "⫯", Z_ = "⧂", W_ = "∲", J_ = "”", Y_ = "’", X_ = "♣", Q_ = "♣", eb = ":", tb = "∷", nb = "⩴", rb = "≔", sb = "≔", ob = ",", cb = "@", ib = "∁", ab = "∘", lb = "∁", ub = "ℂ", fb = "≅", hb = "⩭", pb = "≡", db = "∮", gb = "∯", mb = "∮", _b = "𝕔", bb = "ℂ", vb = "∐", yb = "∐", xb = "©", Eb = "©", kb = "℗", wb = "∳", Ab = "↵", Cb = "✗", Sb = "⨯", Tb = "𝒞", Db = "𝒸", Rb = "⫏", Lb = "⫑", Nb = "⫐", Ib = "⫒", Mb = "⋯", Ob = "⤸", qb = "⤵", Fb = "⋞", Bb = "⋟", Pb = "↶", $b = "⤽", zb = "⩈", Ub = "⩆", Hb = "≍", Vb = "∪", Gb = "⋓", jb = "⩊", Kb = "⊍", Zb = "⩅", Wb = "∪︀", Jb = "↷", Yb = "⤼", Xb = "⋞", Qb = "⋟", e0 = "⋎", t0 = "⋏", n0 = "¤", r0 = "↶", s0 = "↷", o0 = "⋎", c0 = "⋏", i0 = "∲", a0 = "∱", l0 = "⌭", u0 = "†", f0 = "‡", h0 = "ℸ", p0 = "↓", d0 = "↡", g0 = "⇓", m0 = "‐", _0 = "⫤", b0 = "⊣", v0 = "⤏", y0 = "˝", x0 = "Ď", E0 = "ď", k0 = "Д", w0 = "д", A0 = "‡", C0 = "⇊", S0 = "ⅅ", T0 = "ⅆ", D0 = "⤑", R0 = "⩷", L0 = "°", N0 = "∇", I0 = "Δ", M0 = "δ", O0 = "⦱", q0 = "⥿", F0 = "𝔇", B0 = "𝔡", P0 = "⥥", $0 = "⇃", z0 = "⇂", U0 = "´", H0 = "˙", V0 = "˝", G0 = "`", j0 = "˜", K0 = "⋄", Z0 = "⋄", W0 = "⋄", J0 = "♦", Y0 = "♦", X0 = "¨", Q0 = "ⅆ", ev = "ϝ", tv = "⋲", nv = "÷", rv = "÷", sv = "⋇", ov = "⋇", cv = "Ђ", iv = "ђ", av = "⌞", lv = "⌍", uv = "$", fv = "𝔻", hv = "𝕕", pv = "¨", dv = "˙", gv = "⃜", mv = "≐", _v = "≑", bv = "≐", vv = "∸", yv = "∔", xv = "⊡", Ev = "⌆", kv = "∯", wv = "¨", Av = "⇓", Cv = "⇐", Sv = "⇔", Tv = "⫤", Dv = "⟸", Rv = "⟺", Lv = "⟹", Nv = "⇒", Iv = "⊨", Mv = "⇑", Ov = "⇕", qv = "∥", Fv = "⤓", Bv = "↓", Pv = "↓", $v = "⇓", zv = "⇵", Uv = "̑", Hv = "⇊", Vv = "⇃", Gv = "⇂", jv = "⥐", Kv = "⥞", Zv = "⥖", Wv = "↽", Jv = "⥟", Yv = "⥗", Xv = "⇁", Qv = "↧", ey = "⊤", ty = "⤐", ny = "⌟", ry = "⌌", sy = "𝒟", oy = "𝒹", cy = "Ѕ", iy = "ѕ", ay = "⧶", ly = "Đ", uy = "đ", fy = "⋱", hy = "▿", py = "▾", dy = "⇵", gy = "⥯", my = "⦦", _y = "Џ", by = "џ", vy = "⟿", yy = "É", xy = "é", Ey = "⩮", ky = "Ě", wy = "ě", Ay = "Ê", Cy = "ê", Sy = "≖", Ty = "≕", Dy = "Э", Ry = "э", Ly = "⩷", Ny = "Ė", Iy = "ė", My = "≑", Oy = "ⅇ", qy = "≒", Fy = "𝔈", By = "𝔢", Py = "⪚", $y = "È", zy = "è", Uy = "⪖", Hy = "⪘", Vy = "⪙", Gy = "∈", jy = "⏧", Ky = "ℓ", Zy = "⪕", Wy = "⪗", Jy = "Ē", Yy = "ē", Xy = "∅", Qy = "∅", ex = "◻", tx = "∅", nx = "▫", rx = " ", sx = " ", ox = " ", cx = "Ŋ", ix = "ŋ", ax = " ", lx = "Ę", ux = "ę", fx = "𝔼", hx = "𝕖", px = "⋕", dx = "⧣", gx = "⩱", mx = "ε", _x = "Ε", bx = "ε", vx = "ϵ", yx = "≖", xx = "≕", Ex = "≂", kx = "⪖", wx = "⪕", Ax = "⩵", Cx = "=", Sx = "≂", Tx = "≟", Dx = "⇌", Rx = "≡", Lx = "⩸", Nx = "⧥", Ix = "⥱", Mx = "≓", Ox = "ℯ", qx = "ℰ", Fx = "≐", Bx = "⩳", Px = "≂", $x = "Η", zx = "η", Ux = "Ð", Hx = "ð", Vx = "Ë", Gx = "ë", jx = "€", Kx = "!", Zx = "∃", Wx = "∃", Jx = "ℰ", Yx = "ⅇ", Xx = "ⅇ", Qx = "≒", eE = "Ф", tE = "ф", nE = "♀", rE = "ﬃ", sE = "ﬀ", oE = "ﬄ", cE = "𝔉", iE = "𝔣", aE = "ﬁ", lE = "◼", uE = "▪", fE = "fj", hE = "♭", pE = "ﬂ", dE = "▱", gE = "ƒ", mE = "𝔽", _E = "𝕗", bE = "∀", vE = "∀", yE = "⋔", xE = "⫙", EE = "ℱ", kE = "⨍", wE = "½", AE = "⅓", CE = "¼", SE = "⅕", TE = "⅙", DE = "⅛", RE = "⅔", LE = "⅖", NE = "¾", IE = "⅗", ME = "⅜", OE = "⅘", qE = "⅚", FE = "⅝", BE = "⅞", PE = "⁄", $E = "⌢", zE = "𝒻", UE = "ℱ", HE = "ǵ", VE = "Γ", GE = "γ", jE = "Ϝ", KE = "ϝ", ZE = "⪆", WE = "Ğ", JE = "ğ", YE = "Ģ", XE = "Ĝ", QE = "ĝ", ek = "Г", tk = "г", nk = "Ġ", rk = "ġ", sk = "≥", ok = "≧", ck = "⪌", ik = "⋛", ak = "≥", lk = "≧", uk = "⩾", fk = "⪩", hk = "⩾", pk = "⪀", dk = "⪂", gk = "⪄", mk = "⋛︀", _k = "⪔", bk = "𝔊", vk = "𝔤", yk = "≫", xk = "⋙", Ek = "⋙", kk = "ℷ", wk = "Ѓ", Ak = "ѓ", Ck = "⪥", Sk = "≷", Tk = "⪒", Dk = "⪤", Rk = "⪊", Lk = "⪊", Nk = "⪈", Ik = "≩", Mk = "⪈", Ok = "≩", qk = "⋧", Fk = "𝔾", Bk = "𝕘", Pk = "`", $k = "≥", zk = "⋛", Uk = "≧", Hk = "⪢", Vk = "≷", Gk = "⩾", jk = "≳", Kk = "𝒢", Zk = "ℊ", Wk = "≳", Jk = "⪎", Yk = "⪐", Xk = "⪧", Qk = "⩺", ew = ">", tw = ">", nw = "≫", rw = "⋗", sw = "⦕", ow = "⩼", cw = "⪆", iw = "⥸", aw = "⋗", lw = "⋛", uw = "⪌", fw = "≷", hw = "≳", pw = "≩︀", dw = "≩︀", gw = "ˇ", mw = " ", _w = "½", bw = "ℋ", vw = "Ъ", yw = "ъ", xw = "⥈", Ew = "↔", kw = "⇔", ww = "↭", Aw = "^", Cw = "ℏ", Sw = "Ĥ", Tw = "ĥ", Dw = "♥", Rw = "♥", Lw = "…", Nw = "⊹", Iw = "𝔥", Mw = "ℌ", Ow = "ℋ", qw = "⤥", Fw = "⤦", Bw = "⇿", Pw = "∻", $w = "↩", zw = "↪", Uw = "𝕙", Hw = "ℍ", Vw = "―", Gw = "─", jw = "𝒽", Kw = "ℋ", Zw = "ℏ", Ww = "Ħ", Jw = "ħ", Yw = "≎", Xw = "≏", Qw = "⁃", e1 = "‐", t1 = "Í", n1 = "í", r1 = "⁣", s1 = "Î", o1 = "î", c1 = "И", i1 = "и", a1 = "İ", l1 = "Е", u1 = "е", f1 = "¡", h1 = "⇔", p1 = "𝔦", d1 = "ℑ", g1 = "Ì", m1 = "ì", _1 = "ⅈ", b1 = "⨌", v1 = "∭", y1 = "⧜", x1 = "℩", E1 = "Ĳ", k1 = "ĳ", w1 = "Ī", A1 = "ī", C1 = "ℑ", S1 = "ⅈ", T1 = "ℐ", D1 = "ℑ", R1 = "ı", L1 = "ℑ", N1 = "⊷", I1 = "Ƶ", M1 = "⇒", O1 = "℅", q1 = "∞", F1 = "⧝", B1 = "ı", P1 = "⊺", $1 = "∫", z1 = "∬", U1 = "ℤ", H1 = "∫", V1 = "⊺", G1 = "⋂", j1 = "⨗", K1 = "⨼", Z1 = "⁣", W1 = "⁢", J1 = "Ё", Y1 = "ё", X1 = "Į", Q1 = "į", eA = "𝕀", tA = "𝕚", nA = "Ι", rA = "ι", sA = "⨼", oA = "¿", cA = "𝒾", iA = "ℐ", aA = "∈", lA = "⋵", uA = "⋹", fA = "⋴", hA = "⋳", pA = "∈", dA = "⁢", gA = "Ĩ", mA = "ĩ", _A = "І", bA = "і", vA = "Ï", yA = "ï", xA = "Ĵ", EA = "ĵ", kA = "Й", wA = "й", AA = "𝔍", CA = "𝔧", SA = "ȷ", TA = "𝕁", DA = "𝕛", RA = "𝒥", LA = "𝒿", NA = "Ј", IA = "ј", MA = "Є", OA = "є", qA = "Κ", FA = "κ", BA = "ϰ", PA = "Ķ", $A = "ķ", zA = "К", UA = "к", HA = "𝔎", VA = "𝔨", GA = "ĸ", jA = "Х", KA = "х", ZA = "Ќ", WA = "ќ", JA = "𝕂", YA = "𝕜", XA = "𝒦", QA = "𝓀", eC = "⇚", tC = "Ĺ", nC = "ĺ", rC = "⦴", sC = "ℒ", oC = "Λ", cC = "λ", iC = "⟨", aC = "⟪", lC = "⦑", uC = "⟨", fC = "⪅", hC = "ℒ", pC = "«", dC = "⇤", gC = "⤟", mC = "←", _C = "↞", bC = "⇐", vC = "⤝", yC = "↩", xC = "↫", EC = "⤹", kC = "⥳", wC = "↢", AC = "⤙", CC = "⤛", SC = "⪫", TC = "⪭", DC = "⪭︀", RC = "⤌", LC = "⤎", NC = "❲", IC = "{", MC = "[", OC = "⦋", qC = "⦏", FC = "⦍", BC = "Ľ", PC = "ľ", $C = "Ļ", zC = "ļ", UC = "⌈", HC = "{", VC = "Л", GC = "л", jC = "⤶", KC = "“", ZC = "„", WC = "⥧", JC = "⥋", YC = "↲", XC = "≤", QC = "≦", eS = "⟨", tS = "⇤", nS = "←", rS = "←", sS = "⇐", oS = "⇆", cS = "↢", iS = "⌈", aS = "⟦", lS = "⥡", uS = "⥙", fS = "⇃", hS = "⌊", pS = "↽", dS = "↼", gS = "⇇", mS = "↔", _S = "↔", bS = "⇔", vS = "⇆", yS = "⇋", xS = "↭", ES = "⥎", kS = "↤", wS = "⊣", AS = "⥚", CS = "⋋", SS = "⧏", TS = "⊲", DS = "⊴", RS = "⥑", LS = "⥠", NS = "⥘", IS = "↿", MS = "⥒", OS = "↼", qS = "⪋", FS = "⋚", BS = "≤", PS = "≦", $S = "⩽", zS = "⪨", US = "⩽", HS = "⩿", VS = "⪁", GS = "⪃", jS = "⋚︀", KS = "⪓", ZS = "⪅", WS = "⋖", JS = "⋚", YS = "⪋", XS = "⋚", QS = "≦", eT = "≶", tT = "≶", nT = "⪡", rT = "≲", sT = "⩽", oT = "≲", cT = "⥼", iT = "⌊", aT = "𝔏", lT = "𝔩", uT = "≶", fT = "⪑", hT = "⥢", pT = "↽", dT = "↼", gT = "⥪", mT = "▄", _T = "Љ", bT = "љ", vT = "⇇", yT = "≪", xT = "⋘", ET = "⌞", kT = "⇚", wT = "⥫", AT = "◺", CT = "Ŀ", ST = "ŀ", TT = "⎰", DT = "⎰", RT = "⪉", LT = "⪉", NT = "⪇", IT = "≨", MT = "⪇", OT = "≨", qT = "⋦", FT = "⟬", BT = "⇽", PT = "⟦", $T = "⟵", zT = "⟵", UT = "⟸", HT = "⟷", VT = "⟷", GT = "⟺", jT = "⟼", KT = "⟶", ZT = "⟶", WT = "⟹", JT = "↫", YT = "↬", XT = "⦅", QT = "𝕃", eD = "𝕝", tD = "⨭", nD = "⨴", rD = "∗", sD = "_", oD = "↙", cD = "↘", iD = "◊", aD = "◊", lD = "⧫", uD = "(", fD = "⦓", hD = "⇆", pD = "⌟", dD = "⇋", gD = "⥭", mD = "‎", _D = "⊿", bD = "‹", vD = "𝓁", yD = "ℒ", xD = "↰", ED = "↰", kD = "≲", wD = "⪍", AD = "⪏", CD = "[", SD = "‘", TD = "‚", DD = "Ł", RD = "ł", LD = "⪦", ND = "⩹", ID = "<", MD = "<", OD = "≪", qD = "⋖", FD = "⋋", BD = "⋉", PD = "⥶", $D = "⩻", zD = "◃", UD = "⊴", HD = "◂", VD = "⦖", GD = "⥊", jD = "⥦", KD = "≨︀", ZD = "≨︀", WD = "¯", JD = "♂", YD = "✠", XD = "✠", QD = "↦", eR = "↦", tR = "↧", nR = "↤", rR = "↥", sR = "▮", oR = "⨩", cR = "М", iR = "м", aR = "—", lR = "∺", uR = "∡", fR = " ", hR = "ℳ", pR = "𝔐", dR = "𝔪", gR = "℧", mR = "µ", _R = "*", bR = "⫰", vR = "∣", yR = "·", xR = "⊟", ER = "−", kR = "∸", wR = "⨪", AR = "∓", CR = "⫛", SR = "…", TR = "∓", DR = "⊧", RR = "𝕄", LR = "𝕞", NR = "∓", IR = "𝓂", MR = "ℳ", OR = "∾", qR = "Μ", FR = "μ", BR = "⊸", PR = "⊸", $R = "∇", zR = "Ń", UR = "ń", HR = "∠⃒", VR = "≉", GR = "⩰̸", jR = "≋̸", KR = "ŉ", ZR = "≉", WR = "♮", JR = "ℕ", YR = "♮", XR = " ", QR = "≎̸", eL = "≏̸", tL = "⩃", nL = "Ň", rL = "ň", sL = "Ņ", oL = "ņ", cL = "≇", iL = "⩭̸", aL = "⩂", lL = "Н", uL = "н", fL = "–", hL = "⤤", pL = "↗", dL = "⇗", gL = "↗", mL = "≠", _L = "≐̸", bL = "​", vL = "​", yL = "​", xL = "​", EL = "≢", kL = "⤨", wL = "≂̸", AL = "≫", CL = "≪", SL = `
`, TL = "∄", DL = "∄", RL = "𝔑", LL = "𝔫", NL = "≧̸", IL = "≱", ML = "≱", OL = "≧̸", qL = "⩾̸", FL = "⩾̸", BL = "⋙̸", PL = "≵", $L = "≫⃒", zL = "≯", UL = "≯", HL = "≫̸", VL = "↮", GL = "⇎", jL = "⫲", KL = "∋", ZL = "⋼", WL = "⋺", JL = "∋", YL = "Њ", XL = "њ", QL = "↚", eN = "⇍", tN = "‥", nN = "≦̸", rN = "≰", sN = "↚", oN = "⇍", cN = "↮", iN = "⇎", aN = "≰", lN = "≦̸", uN = "⩽̸", fN = "⩽̸", hN = "≮", pN = "⋘̸", dN = "≴", gN = "≪⃒", mN = "≮", _N = "⋪", bN = "⋬", vN = "≪̸", yN = "∤", xN = "⁠", EN = " ", kN = "𝕟", wN = "ℕ", AN = "⫬", CN = "¬", SN = "≢", TN = "≭", DN = "∦", RN = "∉", LN = "≠", NN = "≂̸", IN = "∄", MN = "≯", ON = "≱", qN = "≧̸", FN = "≫̸", BN = "≹", PN = "⩾̸", $N = "≵", zN = "≎̸", UN = "≏̸", HN = "∉", VN = "⋵̸", GN = "⋹̸", jN = "∉", KN = "⋷", ZN = "⋶", WN = "⧏̸", JN = "⋪", YN = "⋬", XN = "≮", QN = "≰", eI = "≸", tI = "≪̸", nI = "⩽̸", rI = "≴", sI = "⪢̸", oI = "⪡̸", cI = "∌", iI = "∌", aI = "⋾", lI = "⋽", uI = "⊀", fI = "⪯̸", hI = "⋠", pI = "∌", dI = "⧐̸", gI = "⋫", mI = "⋭", _I = "⊏̸", bI = "⋢", vI = "⊐̸", yI = "⋣", xI = "⊂⃒", EI = "⊈", kI = "⊁", wI = "⪰̸", AI = "⋡", CI = "≿̸", SI = "⊃⃒", TI = "⊉", DI = "≁", RI = "≄", LI = "≇", NI = "≉", II = "∤", MI = "∦", OI = "∦", qI = "⫽⃥", FI = "∂̸", BI = "⨔", PI = "⊀", $I = "⋠", zI = "⊀", UI = "⪯̸", HI = "⪯̸", VI = "⤳̸", GI = "↛", jI = "⇏", KI = "↝̸", ZI = "↛", WI = "⇏", JI = "⋫", YI = "⋭", XI = "⊁", QI = "⋡", eM = "⪰̸", tM = "𝒩", nM = "𝓃", rM = "∤", sM = "∦", oM = "≁", cM = "≄", iM = "≄", aM = "∤", lM = "∦", uM = "⋢", fM = "⋣", hM = "⊄", pM = "⫅̸", dM = "⊈", gM = "⊂⃒", mM = "⊈", _M = "⫅̸", bM = "⊁", vM = "⪰̸", yM = "⊅", xM = "⫆̸", EM = "⊉", kM = "⊃⃒", wM = "⊉", AM = "⫆̸", CM = "≹", SM = "Ñ", TM = "ñ", DM = "≸", RM = "⋪", LM = "⋬", NM = "⋫", IM = "⋭", MM = "Ν", OM = "ν", qM = "#", FM = "№", BM = " ", PM = "≍⃒", $M = "⊬", zM = "⊭", UM = "⊮", HM = "⊯", VM = "≥⃒", GM = ">⃒", jM = "⤄", KM = "⧞", ZM = "⤂", WM = "≤⃒", JM = "<⃒", YM = "⊴⃒", XM = "⤃", QM = "⊵⃒", eO = "∼⃒", tO = "⤣", nO = "↖", rO = "⇖", sO = "↖", oO = "⤧", cO = "Ó", iO = "ó", aO = "⊛", lO = "Ô", uO = "ô", fO = "⊚", hO = "О", pO = "о", dO = "⊝", gO = "Ő", mO = "ő", _O = "⨸", bO = "⊙", vO = "⦼", yO = "Œ", xO = "œ", EO = "⦿", kO = "𝔒", wO = "𝔬", AO = "˛", CO = "Ò", SO = "ò", TO = "⧁", DO = "⦵", RO = "Ω", LO = "∮", NO = "↺", IO = "⦾", MO = "⦻", OO = "‾", qO = "⧀", FO = "Ō", BO = "ō", PO = "Ω", $O = "ω", zO = "Ο", UO = "ο", HO = "⦶", VO = "⊖", GO = "𝕆", jO = "𝕠", KO = "⦷", ZO = "“", WO = "‘", JO = "⦹", YO = "⊕", XO = "↻", QO = "⩔", e2 = "∨", t2 = "⩝", n2 = "ℴ", r2 = "ℴ", s2 = "ª", o2 = "º", c2 = "⊶", i2 = "⩖", a2 = "⩗", l2 = "⩛", u2 = "Ⓢ", f2 = "𝒪", h2 = "ℴ", p2 = "Ø", d2 = "ø", g2 = "⊘", m2 = "Õ", _2 = "õ", b2 = "⨶", v2 = "⨷", y2 = "⊗", x2 = "Ö", E2 = "ö", k2 = "⌽", w2 = "‾", A2 = "⏞", C2 = "⎴", S2 = "⏜", T2 = "¶", D2 = "∥", R2 = "∥", L2 = "⫳", N2 = "⫽", I2 = "∂", M2 = "∂", O2 = "П", q2 = "п", F2 = "%", B2 = ".", P2 = "‰", $2 = "⊥", z2 = "‱", U2 = "𝔓", H2 = "𝔭", V2 = "Φ", G2 = "φ", j2 = "ϕ", K2 = "ℳ", Z2 = "☎", W2 = "Π", J2 = "π", Y2 = "⋔", X2 = "ϖ", Q2 = "ℏ", eq = "ℎ", tq = "ℏ", nq = "⨣", rq = "⊞", sq = "⨢", oq = "+", cq = "∔", iq = "⨥", aq = "⩲", lq = "±", uq = "±", fq = "⨦", hq = "⨧", pq = "±", dq = "ℌ", gq = "⨕", mq = "𝕡", _q = "ℙ", bq = "£", vq = "⪷", yq = "⪻", xq = "≺", Eq = "≼", kq = "⪷", wq = "≺", Aq = "≼", Cq = "≺", Sq = "⪯", Tq = "≼", Dq = "≾", Rq = "⪯", Lq = "⪹", Nq = "⪵", Iq = "⋨", Mq = "⪯", Oq = "⪳", qq = "≾", Fq = "′", Bq = "″", Pq = "ℙ", $q = "⪹", zq = "⪵", Uq = "⋨", Hq = "∏", Vq = "∏", Gq = "⌮", jq = "⌒", Kq = "⌓", Zq = "∝", Wq = "∝", Jq = "∷", Yq = "∝", Xq = "≾", Qq = "⊰", eF = "𝒫", tF = "𝓅", nF = "Ψ", rF = "ψ", sF = " ", oF = "𝔔", cF = "𝔮", iF = "⨌", aF = "𝕢", lF = "ℚ", uF = "⁗", fF = "𝒬", hF = "𝓆", pF = "ℍ", dF = "⨖", gF = "?", mF = "≟", _F = '"', bF = '"', vF = "⇛", yF = "∽̱", xF = "Ŕ", EF = "ŕ", kF = "√", wF = "⦳", AF = "⟩", CF = "⟫", SF = "⦒", TF = "⦥", DF = "⟩", RF = "»", LF = "⥵", NF = "⇥", IF = "⤠", MF = "⤳", OF = "→", qF = "↠", FF = "⇒", BF = "⤞", PF = "↪", $F = "↬", zF = "⥅", UF = "⥴", HF = "⤖", VF = "↣", GF = "↝", jF = "⤚", KF = "⤜", ZF = "∶", WF = "ℚ", JF = "⤍", YF = "⤏", XF = "⤐", QF = "❳", eB = "}", tB = "]", nB = "⦌", rB = "⦎", sB = "⦐", oB = "Ř", cB = "ř", iB = "Ŗ", aB = "ŗ", lB = "⌉", uB = "}", fB = "Р", hB = "р", pB = "⤷", dB = "⥩", gB = "”", mB = "”", _B = "↳", bB = "ℜ", vB = "ℛ", yB = "ℜ", xB = "ℝ", EB = "ℜ", kB = "▭", wB = "®", AB = "®", CB = "∋", SB = "⇋", TB = "⥯", DB = "⥽", RB = "⌋", LB = "𝔯", NB = "ℜ", IB = "⥤", MB = "⇁", OB = "⇀", qB = "⥬", FB = "Ρ", BB = "ρ", PB = "ϱ", $B = "⟩", zB = "⇥", UB = "→", HB = "→", VB = "⇒", GB = "⇄", jB = "↣", KB = "⌉", ZB = "⟧", WB = "⥝", JB = "⥕", YB = "⇂", XB = "⌋", QB = "⇁", eP = "⇀", tP = "⇄", nP = "⇌", rP = "⇉", sP = "↝", oP = "↦", cP = "⊢", iP = "⥛", aP = "⋌", lP = "⧐", uP = "⊳", fP = "⊵", hP = "⥏", pP = "⥜", dP = "⥔", gP = "↾", mP = "⥓", _P = "⇀", bP = "˚", vP = "≓", yP = "⇄", xP = "⇌", EP = "‏", kP = "⎱", wP = "⎱", AP = "⫮", CP = "⟭", SP = "⇾", TP = "⟧", DP = "⦆", RP = "𝕣", LP = "ℝ", NP = "⨮", IP = "⨵", MP = "⥰", OP = ")", qP = "⦔", FP = "⨒", BP = "⇉", PP = "⇛", $P = "›", zP = "𝓇", UP = "ℛ", HP = "↱", VP = "↱", GP = "]", jP = "’", KP = "’", ZP = "⋌", WP = "⋊", JP = "▹", YP = "⊵", XP = "▸", QP = "⧎", e$ = "⧴", t$ = "⥨", n$ = "℞", r$ = "Ś", s$ = "ś", o$ = "‚", c$ = "⪸", i$ = "Š", a$ = "š", l$ = "⪼", u$ = "≻", f$ = "≽", h$ = "⪰", p$ = "⪴", d$ = "Ş", g$ = "ş", m$ = "Ŝ", _$ = "ŝ", b$ = "⪺", v$ = "⪶", y$ = "⋩", x$ = "⨓", E$ = "≿", k$ = "С", w$ = "с", A$ = "⊡", C$ = "⋅", S$ = "⩦", T$ = "⤥", D$ = "↘", R$ = "⇘", L$ = "↘", N$ = "§", I$ = ";", M$ = "⤩", O$ = "∖", q$ = "∖", F$ = "✶", B$ = "𝔖", P$ = "𝔰", $$ = "⌢", z$ = "♯", U$ = "Щ", H$ = "щ", V$ = "Ш", G$ = "ш", j$ = "↓", K$ = "←", Z$ = "∣", W$ = "∥", J$ = "→", Y$ = "↑", X$ = "­", Q$ = "Σ", ez = "σ", tz = "ς", nz = "ς", rz = "∼", sz = "⩪", oz = "≃", cz = "≃", iz = "⪞", az = "⪠", lz = "⪝", uz = "⪟", fz = "≆", hz = "⨤", pz = "⥲", dz = "←", gz = "∘", mz = "∖", _z = "⨳", bz = "⧤", vz = "∣", yz = "⌣", xz = "⪪", Ez = "⪬", kz = "⪬︀", wz = "Ь", Az = "ь", Cz = "⌿", Sz = "⧄", Tz = "/", Dz = "𝕊", Rz = "𝕤", Lz = "♠", Nz = "♠", Iz = "∥", Mz = "⊓", Oz = "⊓︀", qz = "⊔", Fz = "⊔︀", Bz = "√", Pz = "⊏", $z = "⊑", zz = "⊏", Uz = "⊑", Hz = "⊐", Vz = "⊒", Gz = "⊐", jz = "⊒", Kz = "□", Zz = "□", Wz = "⊓", Jz = "⊏", Yz = "⊑", Xz = "⊐", Qz = "⊒", eU = "⊔", tU = "▪", nU = "□", rU = "▪", sU = "→", oU = "𝒮", cU = "𝓈", iU = "∖", aU = "⌣", lU = "⋆", uU = "⋆", fU = "☆", hU = "★", pU = "ϵ", dU = "ϕ", gU = "¯", mU = "⊂", _U = "⋐", bU = "⪽", vU = "⫅", yU = "⊆", xU = "⫃", EU = "⫁", kU = "⫋", wU = "⊊", AU = "⪿", CU = "⥹", SU = "⊂", TU = "⋐", DU = "⊆", RU = "⫅", LU = "⊆", NU = "⊊", IU = "⫋", MU = "⫇", OU = "⫕", qU = "⫓", FU = "⪸", BU = "≻", PU = "≽", $U = "≻", zU = "⪰", UU = "≽", HU = "≿", VU = "⪰", GU = "⪺", jU = "⪶", KU = "⋩", ZU = "≿", WU = "∋", JU = "∑", YU = "∑", XU = "♪", QU = "¹", e3 = "²", t3 = "³", n3 = "⊃", r3 = "⋑", s3 = "⪾", o3 = "⫘", c3 = "⫆", i3 = "⊇", a3 = "⫄", l3 = "⊃", u3 = "⊇", f3 = "⟉", h3 = "⫗", p3 = "⥻", d3 = "⫂", g3 = "⫌", m3 = "⊋", _3 = "⫀", b3 = "⊃", v3 = "⋑", y3 = "⊇", x3 = "⫆", E3 = "⊋", k3 = "⫌", w3 = "⫈", A3 = "⫔", C3 = "⫖", S3 = "⤦", T3 = "↙", D3 = "⇙", R3 = "↙", L3 = "⤪", N3 = "ß", I3 = "	", M3 = "⌖", O3 = "Τ", q3 = "τ", F3 = "⎴", B3 = "Ť", P3 = "ť", $3 = "Ţ", z3 = "ţ", U3 = "Т", H3 = "т", V3 = "⃛", G3 = "⌕", j3 = "𝔗", K3 = "𝔱", Z3 = "∴", W3 = "∴", J3 = "∴", Y3 = "Θ", X3 = "θ", Q3 = "ϑ", eH = "ϑ", tH = "≈", nH = "∼", rH = "  ", sH = " ", oH = " ", cH = "≈", iH = "∼", aH = "Þ", lH = "þ", uH = "˜", fH = "∼", hH = "≃", pH = "≅", dH = "≈", gH = "⨱", mH = "⊠", _H = "×", bH = "⨰", vH = "∭", yH = "⤨", xH = "⌶", EH = "⫱", kH = "⊤", wH = "𝕋", AH = "𝕥", CH = "⫚", SH = "⤩", TH = "‴", DH = "™", RH = "™", LH = "▵", NH = "▿", IH = "◃", MH = "⊴", OH = "≜", qH = "▹", FH = "⊵", BH = "◬", PH = "≜", $H = "⨺", zH = "⃛", UH = "⨹", HH = "⧍", VH = "⨻", GH = "⏢", jH = "𝒯", KH = "𝓉", ZH = "Ц", WH = "ц", JH = "Ћ", YH = "ћ", XH = "Ŧ", QH = "ŧ", e6 = "≬", t6 = "↞", n6 = "↠", r6 = "Ú", s6 = "ú", o6 = "↑", c6 = "↟", i6 = "⇑", a6 = "⥉", l6 = "Ў", u6 = "ў", f6 = "Ŭ", h6 = "ŭ", p6 = "Û", d6 = "û", g6 = "У", m6 = "у", _6 = "⇅", b6 = "Ű", v6 = "ű", y6 = "⥮", x6 = "⥾", E6 = "𝔘", k6 = "𝔲", w6 = "Ù", A6 = "ù", C6 = "⥣", S6 = "↿", T6 = "↾", D6 = "▀", R6 = "⌜", L6 = "⌜", N6 = "⌏", I6 = "◸", M6 = "Ū", O6 = "ū", q6 = "¨", F6 = "_", B6 = "⏟", P6 = "⎵", $6 = "⏝", z6 = "⋃", U6 = "⊎", H6 = "Ų", V6 = "ų", G6 = "𝕌", j6 = "𝕦", K6 = "⤒", Z6 = "↑", W6 = "↑", J6 = "⇑", Y6 = "⇅", X6 = "↕", Q6 = "↕", eV = "⇕", tV = "⥮", nV = "↿", rV = "↾", sV = "⊎", oV = "↖", cV = "↗", iV = "υ", aV = "ϒ", lV = "ϒ", uV = "Υ", fV = "υ", hV = "↥", pV = "⊥", dV = "⇈", gV = "⌝", mV = "⌝", _V = "⌎", bV = "Ů", vV = "ů", yV = "◹", xV = "𝒰", EV = "𝓊", kV = "⋰", wV = "Ũ", AV = "ũ", CV = "▵", SV = "▴", TV = "⇈", DV = "Ü", RV = "ü", LV = "⦧", NV = "⦜", IV = "ϵ", MV = "ϰ", OV = "∅", qV = "ϕ", FV = "ϖ", BV = "∝", PV = "↕", $V = "⇕", zV = "ϱ", UV = "ς", HV = "⊊︀", VV = "⫋︀", GV = "⊋︀", jV = "⫌︀", KV = "ϑ", ZV = "⊲", WV = "⊳", JV = "⫨", YV = "⫫", XV = "⫩", QV = "В", e4 = "в", t4 = "⊢", n4 = "⊨", r4 = "⊩", s4 = "⊫", o4 = "⫦", c4 = "⊻", i4 = "∨", a4 = "⋁", l4 = "≚", u4 = "⋮", f4 = "|", h4 = "‖", p4 = "|", d4 = "‖", g4 = "∣", m4 = "|", _4 = "❘", b4 = "≀", v4 = " ", y4 = "𝔙", x4 = "𝔳", E4 = "⊲", k4 = "⊂⃒", w4 = "⊃⃒", A4 = "𝕍", C4 = "𝕧", S4 = "∝", T4 = "⊳", D4 = "𝒱", R4 = "𝓋", L4 = "⫋︀", N4 = "⊊︀", I4 = "⫌︀", M4 = "⊋︀", O4 = "⊪", q4 = "⦚", F4 = "Ŵ", B4 = "ŵ", P4 = "⩟", $4 = "∧", z4 = "⋀", U4 = "≙", H4 = "℘", V4 = "𝔚", G4 = "𝔴", j4 = "𝕎", K4 = "𝕨", Z4 = "℘", W4 = "≀", J4 = "≀", Y4 = "𝒲", X4 = "𝓌", Q4 = "⋂", e9 = "◯", t9 = "⋃", n9 = "▽", r9 = "𝔛", s9 = "𝔵", o9 = "⟷", c9 = "⟺", i9 = "Ξ", a9 = "ξ", l9 = "⟵", u9 = "⟸", f9 = "⟼", h9 = "⋻", p9 = "⨀", d9 = "𝕏", g9 = "𝕩", m9 = "⨁", _9 = "⨂", b9 = "⟶", v9 = "⟹", y9 = "𝒳", x9 = "𝓍", E9 = "⨆", k9 = "⨄", w9 = "△", A9 = "⋁", C9 = "⋀", S9 = "Ý", T9 = "ý", D9 = "Я", R9 = "я", L9 = "Ŷ", N9 = "ŷ", I9 = "Ы", M9 = "ы", O9 = "¥", q9 = "𝔜", F9 = "𝔶", B9 = "Ї", P9 = "ї", $9 = "𝕐", z9 = "𝕪", U9 = "𝒴", H9 = "𝓎", V9 = "Ю", G9 = "ю", j9 = "ÿ", K9 = "Ÿ", Z9 = "Ź", W9 = "ź", J9 = "Ž", Y9 = "ž", X9 = "З", Q9 = "з", e8 = "Ż", t8 = "ż", n8 = "ℨ", r8 = "​", s8 = "Ζ", o8 = "ζ", c8 = "𝔷", i8 = "ℨ", a8 = "Ж", l8 = "ж", u8 = "⇝", f8 = "𝕫", h8 = "ℤ", p8 = "𝒵", d8 = "𝓏", g8 = "‍", m8 = "‌", _8 = {
  Aacute: ep,
  aacute: tp,
  Abreve: np,
  abreve: rp,
  ...
  blacksquare: mg,
  blacktriangle: _g,
  blacktriangledown: bg,
  blacktriangleleft: vg,
  blacktriangleright: yg,
  blank: xg,
  blk12: Eg,
  blk14: kg,
  blk34: wg,
  ...
  cirmid: K_,
  cirscir: Z_,
  ClockwiseContourIntegral: W_,
  CloseCurlyDoubleQuote: J_,
  CloseCurlyQuote: Y_,
  clubs: X_,
  clubsuit: Q_,
  colon: eb,
  ...
  COPY: Eb,
  copysr: kb,
  CounterClockwiseContourIntegral: wb,
  crarr: Ab,
  cross: Cb,
  Cross: Sb,
  Cscr: Tb,
  ...
  DoubleDownArrow: Av,
  DoubleLeftArrow: Cv,
  DoubleLeftRightArrow: Sv,
  DoubleLeftTee: Tv,
  DoubleLongLeftArrow: Dv,
  DoubleLongLeftRightArrow: Rv,
  DoubleLongRightArrow: Lv,
  DoubleRightArrow: Nv,
  DoubleRightTee: Iv,
  DoubleUpArrow: Mv,
  DoubleUpDownArrow: Ov,
  DoubleVerticalBar: qv,
  DownArrowBar: Fv,
  downarrow: Bv,
  DownArrow: Pv,
  Downarrow: $v,
  ...
  downharpoonleft: Vv,
  downharpoonright: Gv,
  DownLeftRightVector: jv,
  DownLeftTeeVector: Kv,
  DownLeftVectorBar: Zv,
  DownLeftVector: Wv,
  DownRightTeeVector: Jv,
  DownRightVectorBar: Yv,
  DownRightVector: Xv,
  DownTeeArrow: Qv,
  DownTee: ey,
  drbkarow: ty,
  ...
  ffr: iE,
  filig: aE,
  FilledSmallSquare: lE,
  FilledVerySmallSquare: uE,
  fjlig: fE,
  flat: hE,
  fllig: pE,
  fltns: dE,
  ...
  LeftArrow: rS,
  Leftarrow: sS,
  LeftArrowRightArrow: oS,
  leftarrowtail: cS,
  LeftCeiling: iS,
  LeftDoubleBracket: aS,
  LeftDownTeeVector: lS,
  LeftDownVectorBar: uS,
  LeftDownVector: fS,
  LeftFloor: hS,
  leftharpoondown: pS,
  leftharpoonup: dS,
  ...
  Leftrightarrow: bS,
  leftrightarrows: vS,
  leftrightharpoons: yS,
  leftrightsquigarrow: xS,
  LeftRightVector: ES,
  LeftTeeArrow: kS,
  LeftTee: wS,
  LeftTeeVector: AS,
  ...
  LongLeftArrow: zT,
  Longleftarrow: UT,
  longleftrightarrow: HT,
  LongLeftRightArrow: VT,
  Longleftrightarrow: GT,
  longmapsto: jT,
  longrightarrow: KT,
  LongRightArrow: ZT,
  Longrightarrow: WT,
  ...
  ne: mL,
  nedot: _L,
  NegativeMediumSpace: bL,
  NegativeThickSpace: vL,
  NegativeThinSpace: yL,
  NegativeVeryThinSpace: xL,
  nequiv: EL,
  nesear: kL,
  nesim: wL,
  NestedGreaterGreater: AL,
  NestedLessLess: CL,
  NewLine: SL,
  nexist: TL,
  nexists: DL,
  ...
  NotGreater: MN,
  NotGreaterEqual: ON,
  NotGreaterFullEqual: qN,
  NotGreaterGreater: FN,
  NotGreaterLess: BN,
  NotGreaterSlantEqual: PN,
  NotGreaterTilde: $N,
  NotHumpDownHump: zN,
  NotHumpEqual: UN,
  notin: HN,
  ...
  notinvb: KN,
  notinvc: ZN,
  NotLeftTriangleBar: WN,
  NotLeftTriangle: JN,
  NotLeftTriangleEqual: YN,
  NotLess: XN,
  NotLessEqual: QN,
  NotLessGreater: eI,
  NotLessLess: tI,
  NotLessSlantEqual: nI,
  NotLessTilde: rI,
  NotNestedGreaterGreater: sI,
  NotNestedLessLess: oI,
  notni: cI,
  notniva: iI,
  notnivb: aI,
  notnivc: lI,
  NotPrecedes: uI,
  NotPrecedesEqual: fI,
  NotPrecedesSlantEqual: hI,
  NotReverseElement: pI,
  NotRightTriangleBar: dI,
  NotRightTriangle: gI,
  NotRightTriangleEqual: mI,
  NotSquareSubset: _I,
  NotSquareSubsetEqual: bI,
  NotSquareSuperset: vI,
  NotSquareSupersetEqual: yI,
  NotSubset: xI,
  NotSubsetEqual: EI,
  NotSucceeds: kI,
  NotSucceedsEqual: wI,
  NotSucceedsSlantEqual: AI,
  NotSucceedsTilde: CI,
  NotSuperset: SI,
  NotSupersetEqual: TI,
  NotTilde: DI,
  NotTildeEqual: RI,
  NotTildeFullEqual: LI,
  NotTildeTilde: NI,
  NotVerticalBar: II,
  nparallel: MI,
  npar: OI,
  ...
  REG: AB,
  ReverseElement: CB,
  ReverseEquilibrium: SB,
  ReverseUpEquilibrium: TB,
  rfisht: DB,
  rfloor: RB,
  rfr: LB,
  Rfr: NB,
  ...
  RightArrow: HB,
  Rightarrow: VB,
  RightArrowLeftArrow: GB,
  rightarrowtail: jB,
  RightCeiling: KB,
  RightDoubleBracket: ZB,
  RightDownTeeVector: WB,
  RightDownVectorBar: JB,
  RightDownVector: YB,
  RightFloor: XB,
  rightharpoondown: QB,
  rightharpoonup: eP,
  rightleftarrows: tP,
  rightleftharpoons: nP,
  rightrightarrows: rP,
  rightsquigarrow: sP,
  RightTeeArrow: oP,
  RightTee: cP,
  ...
  square: Kz,
  Square: Zz,
  SquareIntersection: Wz,
  SquareSubset: Jz,
  SquareSubsetEqual: Yz,
  SquareSuperset: Xz,
  SquareSupersetEqual: Qz,
  SquareUnion: eU,
  squarf: tU,
  squ: nU,
  squf: rU,
...
var da = _8, no = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166D\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4E\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDF55-\uDF59]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDF3C-\uDF3E]|\uD806[\uDC3B\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8]|\uD809[\uDC70-\uDC74]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/, rn = {}, uc = {};
function b8(t) {
  var e, n, r = uc[t];
  if (r)
    return r;
  for (r = uc[t] = [], e = 0; e < 128; e++)
...
function Dr(t, e, n) {
  var r, s, o, c, i, a = "";
  for (typeof e != "string" && (n = e, e = Dr.defaultChars), typeof n > "u" && (n = !0), i = b8(e), r = 0, s = t.length; r < s; r++) {
...
function Rr(t, e) {
  var n;
  return typeof e != "string" && (e = Rr.defaultChars), n = y8(e), t.replace(/(%[a-f0-9]{2})+/gi, function(r) {
    var s, o, c, i, a, l, u, f = "";
...
var k8 = /^([a-z0-9.+-]+:)/i, w8 = /:[0-9]*$/, A8 = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/, C8 = ["<", ">", '"', "`", " ", "\r", `
`, "	"], S8 = ["{", "}", "|", "\\", "^", "`"].concat(C8), T8 = ["'"].concat(S8), hc = ["%", "/", "?", ";", "#"].concat(T8), pc = ["/", "?", "#"], D8 = 255, dc = /^[+a-z0-9A-Z_-]{0,63}$/, R8 = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, gc = {
  javascript: !0,
  "javascript:": !0
}, mc = {
  http: !0,
...
function L8(t, e) {
  if (t && t instanceof ur)
    return t;
  var n = new ur();
  return n.parse(t, e), n;
}
ur.prototype.parse = function(t, e) {
  var n, r, s, o, c, i = t;
  ...
  var l = k8.exec(i);
  if (l && (l = l[0], s = l.toLowerCase(), this.protocol = l, i = i.substr(l.length)), (e || l || i.match(/^\/\/[^@\/]+@[^@\/]+/)) && (c = i.substr(0, 2) === "//", c && !(l && gc[l]) && (i = i.substr(2), this.slashes = !0)), !gc[l] && (c || l && !mc[l])) {
    var u = -1;
    for (n = 0; n < pc.length; n++)
      o = i.indexOf(pc[n]), o !== -1 && (u === -1 || o < u) && (u = o);
    var f, h;
    for (u === -1 ? h = i.lastIndexOf("@") : h = i.lastIndexOf("@", u), h !== -1 && (f = i.slice(0, h), i = i.slice(h + 1), this.auth = f), u = -1, n = 0; n < hc.length; n++)
      o = i.indexOf(hc[n]), o !== -1 && (u === -1 || o < u) && (u = o);
    ...
    if (!m) {
      ...
      for (n = 0, r = _.length; n < r; n++) {
        ...
        if (R && !R.match(dc)) {
          ...
          if (!T.match(dc)) {
            var B = _.slice(0, n), P = _.slice(n + 1), y = R.match(R8);
    ...
    this.hostname.length > D8 && (this.hostname = ""), m && (this.hostname = this.hostname.substr(1, this.hostname.length - 2));
  }
  var W = i.indexOf("#");
  W !== -1 && (this.hash = i.substr(W), i = i.slice(0, W));
  var $ = i.indexOf("?");
  return $ !== -1 && (this.search = i.substr($), i = i.slice(0, $)), i && (this.pathname = i), mc[s] && this.hostname && !this.pathname && (this.pathname = ""), this;
};
ur.prototype.parseHost = function(t) {
  var e = w8.exec(t);
...
var St = {}, Jr, _c;
function ga() {
  return _c || (_c = 1, Jr = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/), Jr;
}
var Yr, bc;
function ma() {
  return bc || (bc = 1, Yr = /[\0-\x1F\x7F-\x9F]/), Yr;
}
var Xr, vc;
function I8() {
  return vc || (vc = 1, Xr = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/), Xr;
}
var Qr, yc;
function _a() {
  return yc || (yc = 1, Qr = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/), Qr;
}
var xc;
function M8() {
  return xc || (xc = 1, St.Any = ga(), St.Cc = ma(), St.Cf = I8(), St.P = no, St.Z = _a()), St;
}
(function(t) {
  function e(A) {
  ...
  var l = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g, u = /&([a-z#][a-z0-9]{1,31});/gi, f = new RegExp(l.source + "|" + u.source, "gi"), h = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i, d = da;
  function m(A, K) {
    var F;
  ...
  t.lib = {}, t.lib.mdurl = rn, t.lib.ucmicro = M8(), t.assign = o, t.isString = n, t.has = s, t.unescapeMd = _, t.unescapeAll = R, t.isValidEntityCode = i, t.fromCodePoint = a, t.escapeHtml = P, t.arrayReplaceAt = c, t.isSpace = $, t.isWhiteSpace = Q, t.isMdAsciiPunct = L, t.isPunctChar = oe, t.escapeRE = W, t.normalizeReference = ee;
})(le);
var Lr = {}, O8 = function(e, n, r) {
...
}, Ec = le.unescapeAll, q8 = function(e, n, r) {
  var s, o, c = n, i = {
    ok: !1,
    pos: 0,
    lines: 0,
  ...
  if (e.charCodeAt(c) === 60) {
    for (c++; c < r; ) {
      if (s = e.charCodeAt(c), s === 10 || s === 60)
        return i;
      if (s === 62)
        return i.pos = c + 1, i.str = Ec(e.slice(n + 1, c)), i.ok = !0, i;
      if (s === 92 && c + 1 < r) {
        c += 2;
        continue;
      }
  ...
  return n === c || o !== 0 || (i.str = Ec(e.slice(n, c)), i.pos = c, i.ok = !0), i;
}, F8 = le.unescapeAll, B8 = function(e, n, r) {
  var s, o, c = 0, i = n, a = {
    ok: !1,
    pos: 0,
    lines: 0,
  ...
  for (i++, o === 40 && (o = 41); i < r; ) {
    if (s = e.charCodeAt(i), s === o)
      return a.pos = i + 1, a.lines = c, a.str = F8(e.slice(n + 1, i)), a.ok = !0, a;
    if (s === 40 && o === 41)
      return a;
...
Lr.parseLinkLabel = O8;
Lr.parseLinkDestination = q8;
Lr.parseLinkTitle = B8;
var P8 = le.assign, $8 = le.unescapeAll, qt = le.escapeHtml, et = {};
...
et.fence = function(t, e, n, r, s) {
  var o = t[e], c = o.info ? $8(o.info).trim() : "", i = "", a = "", l, u, f, h, d;
...
var ro = je, U8 = /\r\n?|\n/g, H8 = /\0/g, V8 = function(e) {
  var n;
  n = e.src.replace(U8, `
`), n = n.replace(H8, "�"), e.src = n;
}, G8 = function(e) {
  var n;
    ...
    for (r = 0, s = D.length; r < s; r++)
      if (!(D[r].type !== "inline" || !e.md.linkify.pretest(D[r].content)))
        for (o = D[r].children, m = 0, n = o.length - 1; n >= 0; n--) {
          ...
          if (i.type === "html_inline" && (Z8(i.content) && m > 0 && m--, W8(i.content) && m++), !(m > 0) && i.type === "text" && e.md.linkify.test(i.content)) {
            ...
            h < u.length && (c = new e.Token("text", "", 0), c.content = u.slice(h), c.level = d, a.push(c)), D[r].children = o = K8(o, n, a);
          }
        }
  }
}, ba = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, Y8 = /\((c|tm|r)\)/i, X8 = /\((c|tm|r)\)/ig, Q8 = {
  c: "©",
  r: "®",
  tm: "™"
};
function e5(t, e) {
  return Q8[e.toLowerCase()];
}
function t5(t) {
  var e, n, r = 0;
  for (e = t.length - 1; e >= 0; e--)
    n = t[e], n.type === "text" && !r && (n.content = n.content.replace(X8, e5)), n.type === "link_open" && n.info === "auto" && r--, n.type === "link_close" && n.info === "auto" && r++;
}
function n5(t) {
  var e, n, r = 0;
  for (e = t.length - 1; e >= 0; e--)
    n = t[e], n.type === "text" && !r && ba.test(n.content) && (n.content = n.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/mg, "$1—").replace(/(^|\s)--(?=\s|$)/mg, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg, "$1–")), n.type === "link_open" && n.info === "auto" && r--, n.type === "link_close" && n.info === "auto" && r++;
}
var r5 = function(e) {
  var n;
  if (e.md.options.typographer)
    for (n = e.tokens.length - 1; n >= 0; n--)
      e.tokens[n].type === "inline" && (Y8.test(e.tokens[n].content) && t5(e.tokens[n].children), ba.test(e.tokens[n].content) && n5(e.tokens[n].children));
}, kc = le.isWhiteSpace, wc = le.isPunctChar, Ac = le.isMdAsciiPunct, s5 = /['"]/, Cc = /['"]/g, Sc = "’";
function Vn(t, e, n) {
...
function o5(t, e) {
  ...
  for (B = [], n = 0; n < t.length; n++) {
    ...
    if (B.length = D + 1, r.type === "text") {
      ...
      e:
        for (; c < i && (Cc.lastIndex = c, o = Cc.exec(s), !!o); ) {
          ...
          if (h = Ac(u) || wc(String.fromCharCode(u)), d = Ac(f) || wc(String.fromCharCode(f)), m = kc(u), _ = kc(f), _ ? R = !1 : d && (m || h || (R = !1)), m ? T = !1 : h && (_ || d || (T = !1)), f === 34 && o[0] === '"' && u >= 48 && u <= 57 && (T = R = !1), R && T && (R = h, T = d), !R && !T) {
            I && (r.content = Vn(r.content, o.index, Sc));
            continue;
          }
          if (T) {
            for (D = B.length - 1; D >= 0 && (l = B[D], !(B[D].level < a)); D--)
              if (l.single === I && B[D].level === a) {
                l = B[D], I ? (P = e.md.options.quotes[2], y = e.md.options.quotes[3]) : (P = e.md.options.quotes[0], y = e.md.options.quotes[1]), r.content = Vn(r.content, o.index, y), t[l.token].content = Vn(
                  t[l.token].content,
                  l.pos,
                  P
          ...
          R ? B.push({
            ...
            single: I,
            level: a
          }) : T && I && (r.content = Vn(r.content, o.index, Sc));
        }
    }
  }
}
var c5 = function(e) {
  ...
  if (e.md.options.typographer)
    for (n = e.tokens.length - 1; n >= 0; n--)
      e.tokens[n].type !== "inline" || !s5.test(e.tokens[n].content) || o5(e.tokens[n].children, e);
}, i5 = function(e) {
...
function oo() {
  ...
  for (var t = 0; t < es.length; t++)
    this.ruler.push(es[t][0], es[t][1]);
}
oo.prototype.process = function(t) {
  var e, n, r;
  for (r = this.ruler.getRules(""), e = 0, n = r.length; e < n; e++)
    r[e](t);
};
oo.prototype.State = l5;
var f5 = oo, ts = le.isSpace;
function ns(t, e) {
...
var h5 = function(e, n, r, s) {
  var o, c, i, a, l, u, f, h, d, m, _, R, T, D, I, B, P, y;
  if (n + 2 > r || (u = n + 1, e.sCount[u] < e.blkIndent) || e.sCount[u] - e.blkIndent >= 4 || (i = e.bMarks[u] + e.tShift[u], i >= e.eMarks[u]) || (P = e.src.charCodeAt(i++), P !== 124 && P !== 45 && P !== 58) || i >= e.eMarks[u] || (y = e.src.charCodeAt(i++), y !== 124 && y !== 45 && y !== 58 && !ts(y)) || P === 45 && ts(y))
    return !1;
  for (; i < e.eMarks[u]; ) {
    if (o = e.src.charCodeAt(i), o !== 124 && o !== 45 && o !== 58 && !ts(o))
      return !1;
    i++;
  }
  for (c = ns(e, n + 1), f = c.split("|"), m = [], a = 0; a < f.length; a++) {
    if (_ = f[a].trim(), !_) {
      if (a === 0 || a === f.length - 1)
        continue;
      return !1;
  ...
  if (c = ns(e, n).trim(), c.indexOf("|") === -1 || e.sCount[n] - e.blkIndent >= 4 || (f = Tc(c), f.length && f[0] === "" && f.shift(), f.length && f[f.length - 1] === "" && f.pop(), h = f.length, h === 0 || h !== m.length))
    return !1;
  if (s)
    return !0;
  ...
  for (d = e.push("tr_close", "tr", -1), d = e.push("thead_close", "thead", -1), u = n + 2; u < r && !(e.sCount[u] < e.blkIndent); u++) {
    ...
    if (I || (c = ns(e, u).trim(), !c) || e.sCount[u] - e.blkIndent >= 4)
      break;
    for (f = Tc(c), f.length && f[0] === "" && f.shift(), f.length && f[f.length - 1] === "" && f.pop(), u === n + 2 && (d = e.push("tbody_open", "tbody", 1), d.map = T = [n + 2, 0]), d = e.push("tr_open", "tr", 1), d.map = [u, u + 1], a = 0; a < h; a++)
...
}, g5 = le.isSpace, m5 = function(e, n, r, s) {
  var o, c, i, a, l, u, f, h, d, m, _, R, T, D, I, B, P, y, W, $, Q = e.lineMax, U = e.bMarks[n] + e.tShift[n], oe = e.eMarks[n];
  if (e.sCount[n] - e.blkIndent >= 4 || e.src.charCodeAt(U) !== 62)
    return !1;
  if (s)
    return !0;
  for (m = [], _ = [], D = [], I = [], y = e.md.block.ruler.getRules("blockquote"), T = e.parentType, e.parentType = "blockquote", h = n; h < r && ($ = e.sCount[h] < e.blkIndent, U = e.bMarks[h] + e.tShift[h], oe = e.eMarks[h], !(U >= oe)); h++) {
    if (e.src.charCodeAt(U++) === 62 && !$) {
      for (a = e.sCount[h] + 1, e.src.charCodeAt(U) === 32 ? (U++, a++, o = !1, B = !0) : e.src.charCodeAt(U) === 9 ? (B = !0, (e.bsCount[h] + a) % 4 === 3 ? (U++, a++, o = !1) : o = !0) : B = !1, d = a, m.push(e.bMarks[h]), e.bMarks[h] = U; U < oe && (c = e.src.charCodeAt(U), g5(c)); ) {
        c === 9 ? d += 4 - (d + e.bsCount[h] + (o ? 1 : 0)) % 4 : d++;
        U++;
      }
      u = U >= oe, _.push(e.bsCount[h]), e.bsCount[h] = e.sCount[h] + 1 + (B ? 1 : 0), D.push(e.sCount[h]), e.sCount[h] = d - a, I.push(e.tShift[h]), e.tShift[h] = U - e.bMarks[h];
      continue;
    }
    if (u)
      break;
...
function Dc(t, e) {
  var n, r, s, o;
  return r = t.bMarks[e] + t.tShift[e], s = t.eMarks[e], n = t.src.charCodeAt(r++), n !== 42 && n !== 45 && n !== 43 || r < s && (o = t.src.charCodeAt(r), !ya(o)) ? -1 : r;
}
function Rc(t, e) {
  ...
  return s < o && (n = t.src.charCodeAt(s), !ya(n)) ? -1 : s;
}
function v5(t, e) {
  var n, r, s = t.level + 2;
...
var y5 = function(e, n, r, s) {
  var o, c, i, a, l, u, f, h, d, m, _, R, T, D, I, B, P, y, W, $, Q, U, oe, L, ee, A, K, F = n, v = !1, C = !0;
  if (e.sCount[F] - e.blkIndent >= 4 || e.listIndent >= 0 && e.sCount[F] - e.listIndent >= 4 && e.sCount[F] < e.blkIndent)
    return !1;
  if (s && e.parentType === "paragraph" && e.sCount[F] >= e.blkIndent && (v = !0), (U = Rc(e, F)) >= 0) {
    if (f = !0, L = e.bMarks[F] + e.tShift[F], T = Number(e.src.slice(L, U - 1)), v && T !== 1)
      return !1;
  } else if ((U = Dc(e, F)) >= 0)
    f = !1;
  else
    return !1;
  if (v && e.skipSpaces(U) >= e.eMarks[F])
    return !1;
  if (s)
    return !0;
  for (R = e.src.charCodeAt(U - 1), _ = e.tokens.length, f ? (K = e.push("ordered_list_open", "ol", 1), T !== 1 && (K.attrs = [["start", T]])) : K = e.push("bullet_list_open", "ul", 1), K.map = m = [F, 0], K.markup = String.fromCharCode(R), oe = !1, A = e.md.block.ruler.getRules("list"), P = e.parentType, e.parentType = "list"; F < r; ) {
    for (Q = U, D = e.eMarks[F], u = I = e.sCount[F] + U - (e.bMarks[F] + e.tShift[F]); Q < D; ) {
    ...
    } else if (U = Dc(e, F), U < 0)
      break;
    if (R !== e.src.charCodeAt(U - 1))
      break;
  }
  return f ? K = e.push("ordered_list_close", "ol", -1) : K = e.push("bullet_list_close", "ul", -1), K.markup = String.fromCharCode(R), m[1] = F, e.line = F, e.parentType = P, C && v5(e, _), !0;
}, x5 = le.normalizeReference, Gn = le.isSpace, E5 = function(e, n, r, s) {
  ...
  for (y = _.pos, P += _.lines, c = y, i = P, R = y; y < W; y++)
    if (o = T.charCodeAt(y), o === 10)
      ...
      break;
  for (_ = e.md.helpers.parseLinkTitle(T, y, W), y < W && R !== y && _.ok ? (B = _.str, y = _.pos, P += _.lines) : (B = "", y = c, P = i); y < W && (o = T.charCodeAt(y), !!Gn(o)); )
    y++;
  if (y < W && T.charCodeAt(y) !== 10 && B)
    for (B = "", y = c, P = i; y < W && (o = T.charCodeAt(y), !!Gn(o)); )
      y++;
  return y < W && T.charCodeAt(y) !== 10 || (h = x5(T.slice(1, d)), !h) ? !1 : (s || (typeof e.env.references > "u" && (e.env.references = {}), typeof e.env.references[h] > "u" && (e.env.references[h] = { title: B, href: l }), e.parentType = m, e.line = n + P + 1), !0);
}, k5 = [
  "address",
  "article",
  "aside",
  ...
  "track",
  "ul"
], Nr = {}, w5 = "[a-zA-Z_:][a-zA-Z0-9:._-]*", A5 = "[^\"'=<>`\\x00-\\x20]+", C5 = "'[^']*'", S5 = '"[^"]*"', T5 = "(?:" + A5 + "|" + C5 + "|" + S5 + ")", D5 = "(?:\\s+" + w5 + "(?:\\s*=\\s*" + T5 + ")?)", xa = "<[A-Za-z][A-Za-z0-9\\-]*" + D5 + "*\\s*\\/?>", Ea = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", R5 = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->", L5 = "<[?][\\s\\S]*?[?]>", N5 = "<![A-Z]+\\s+[^>]*>", I5 = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", M5 = new RegExp("^(?:" + xa + "|" + Ea + "|" + R5 + "|" + L5 + "|" + N5 + "|" + I5 + ")"), O5 = new RegExp("^(?:" + xa + "|" + Ea + ")");
Nr.HTML_TAG_RE = M5;
Nr.HTML_OPEN_CLOSE_TAG_RE = O5;
var q5 = k5, F5 = Nr.HTML_OPEN_CLOSE_TAG_RE, Vt = [
...
tt.prototype.Token = ka;
var U5 = tt, H5 = ro, jn = [
  // First 2 params - rule name & source. Secondary array - list of rules,
  // which can be terminated by this one.
  ["table", h5, ["paragraph", "reference"]],
  ["code", p5],
  ["fence", d5, ["paragraph", "reference", "blockquote", "list"]],
  ["blockquote", m5, ["paragraph", "reference", "blockquote", "list"]],
  ["hr", b5, ["paragraph", "reference", "blockquote", "list"]],
  ["list", y5, ["paragraph", "reference", "blockquote"]],
  ["reference", E5],
  ["html_block", B5, ["paragraph", "reference", "blockquote"]],
  ["heading", P5, ["paragraph", "reference", "blockquote"]],
  ["lheading", $5],
  ["paragraph", z5]
];
function Mr() {
  ...
  for (var t = 0; t < jn.length; t++)
    this.ruler.push(jn[t][0], jn[t][1], { alt: (jn[t][2] || []).slice() });
}
...
var j5 = function(e, n) {
  for (var r = e.pos; r < e.posMax && !G5(e.src.charCodeAt(r)); )
    r++;
  return r === e.pos ? !1 : (n || (e.pending += e.src.slice(e.pos, r)), e.pos = r, !0);
}, K5 = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i, Z5 = function(e, n) {
  var r, s, o, c, i, a, l, u;
  return !e.md.options.linkify || e.linkLevel > 0 || (r = e.pos, s = e.posMax, r + 3 > s) || e.src.charCodeAt(r) !== 58 || e.src.charCodeAt(r + 1) !== 47 || e.src.charCodeAt(r + 2) !== 47 || (o = e.pending.match(K5), !o) || (c = o[1], i = e.md.linkify.matchAtStart(e.src.slice(r - c.length)), !i) || (a = i.url, a.length <= c.length) || (a = a.replace(/\*+$/, ""), l = e.md.normalizeLink(a), !e.md.validateLink(l)) ? !1 : (n || (e.pending = e.pending.slice(0, -c.length), u = e.push("link_open", "a", 1), u.attrs = [["href", l]], u.markup = "linkify", u.info = "auto", u = e.push("text", "", 0), u.content = e.md.normalizeLinkText(a), u = e.push("link_close", "a", -1), u.markup = "linkify", u.info = "auto"), e.pos += a.length - c.length, !0);
}, W5 = le.isSpace, J5 = function(e, n) {
  var r, s, o, c = e.pos;
  ...
  for (c++; c < s && W5(e.src.charCodeAt(c)); )
    c++;
  return e.pos = c, !0;
}, Y5 = le.isSpace, co = [];
for (var Nc = 0; Nc < 256; Nc++)
  co.push(0);
...
var X5 = function(e, n) {
  ...
  if (r = e.src.charCodeAt(a), r === 10) {
    for (n || e.push("hardbreak", "br", 0), a++; a < l && (r = e.src.charCodeAt(a), !!Y5(r)); )
      a++;
    return e.pos = a, !0;
  }
  return c = e.src[a], r >= 55296 && r <= 56319 && a + 1 < l && (s = e.src.charCodeAt(a + 1), s >= 56320 && s <= 57343 && (c += e.src[a + 1], a++)), o = "\\" + c, n || (i = e.push("text_special", "", 0), r < 256 && co[r] !== 0 ? i.content = c : i.content = o, i.markup = o, i.info = "escape"), e.pos = a + 1, !0;
}, Q5 = function(e, n) {
...
Or.postProcess = function(e) {
  ...
  for (Ic(e, e.delimiters), n = 0; n < s; n++)
    r[n] && r[n].delimiters && Ic(e, r[n].delimiters);
};
var qr = {};
...
qr.postProcess = function(e) {
  var n, r = e.tokens_meta, s = e.tokens_meta.length;
  for (Mc(e, e.delimiters), n = 0; n < s; n++)
    r[n] && r[n].delimiters && Mc(e, r[n].delimiters);
};
var eG = le.normalizeReference, rs = le.isSpace, tG = function(e, n) {
  ...
  if (a = c + 1, a < _ && e.src.charCodeAt(a) === 40) {
    for (T = !1, a++; a < _ && (s = e.src.charCodeAt(a), !(!rs(s) && s !== 10)); a++)
      ;
    if (a >= _)
      return !1;
    if (R = a, l = e.md.helpers.parseLinkDestination(e.src, a, e.posMax), l.ok) {
      for (h = e.md.normalizeLink(l.str), e.md.validateLink(h) ? a = l.pos : h = "", R = a; a < _ && (s = e.src.charCodeAt(a), !(!rs(s) && s !== 10)); a++)
        ;
      if (l = e.md.helpers.parseLinkTitle(e.src, a, e.posMax), a < _ && R !== a && l.ok)
        for (d = l.str, a = l.pos; a < _ && (s = e.src.charCodeAt(a), !(!rs(s) && s !== 10)); a++)
          ;
    }
  ...
  if (T) {
    if (typeof e.env.references > "u")
      return !1;
    if (a < _ && e.src.charCodeAt(a) === 91 ? (R = a + 1, a = e.md.helpers.parseLinkLabel(e, a), a >= 0 ? o = e.src.slice(R, a++) : a = c + 1) : a = c + 1, o || (o = e.src.slice(i, c)), u = e.env.references[eG(o)], !u)
      return e.pos = m, !1;
    h = u.href, d = u.title;
  }
...
}, nG = le.normalizeReference, ss = le.isSpace, rG = function(e, n) {
  ...
  if (l = i + 1, l < D && e.src.charCodeAt(l) === 40) {
    for (l++; l < D && (s = e.src.charCodeAt(l), !(!ss(s) && s !== 10)); l++)
      ;
    if (l >= D)
      return !1;
    for (_ = l, f = e.md.helpers.parseLinkDestination(e.src, l, e.posMax), f.ok && (R = e.md.normalizeLink(f.str), e.md.validateLink(R) ? l = f.pos : R = ""), _ = l; l < D && (s = e.src.charCodeAt(l), !(!ss(s) && s !== 10)); l++)
      ;
    if (f = e.md.helpers.parseLinkTitle(e.src, l, e.posMax), l < D && _ !== l && f.ok)
      for (h = f.str, l = f.pos; l < D && (s = e.src.charCodeAt(l), !(!ss(s) && s !== 10)); l++)
        ;
    else
      h = "";
    ...
    if (typeof e.env.references > "u")
      return !1;
    if (l < D && e.src.charCodeAt(l) === 91 ? (_ = l + 1, l = e.md.helpers.parseLinkLabel(e, l), l >= 0 ? c = e.src.slice(_, l++) : l = i + 1) : l = i + 1, c || (c = e.src.slice(a, i)), u = e.env.references[nG(c)], !u)
      return e.pos = T, !1;
    R = u.href, h = u.title;
  }
...
}, sG = /^([a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, oG = /^([a-zA-Z][a-zA-Z0-9+.\-]{1,31}):([^<>\x00-\x20]*)$/, cG = function(e, n) {
  ...
  return r = e.src.slice(i + 1, l), oG.test(r) ? (s = e.md.normalizeLink(r), e.md.validateLink(s) ? (n || (o = e.push("link_open", "a", 1), o.attrs = [["href", s]], o.markup = "autolink", o.info = "auto", o = e.push("text", "", 0), o.content = e.md.normalizeLinkText(r), o = e.push("link_close", "a", -1), o.markup = "autolink", o.info = "auto"), e.pos += r.length + 2, !0) : !1) : sG.test(r) ? (s = e.md.normalizeLink("mailto:" + r), e.md.validateLink(s) ? (n || (o = e.push("link_open", "a", 1), o.attrs = [["href", s]], o.markup = "autolink", o.info = "auto", o = e.push("text", "", 0), o.content = e.md.normalizeLinkText(r), o = e.push("link_close", "a", -1), o.markup = "autolink", o.info = "auto"), e.pos += r.length + 2, !0) : !1) : !1;
}, iG = Nr.HTML_TAG_RE;
function aG(t) {
  return /^<a[>\s]/i.test(t);
}
...
var fG = function(e, n) {
  var r, s, o, c, i = e.pos;
  return !e.md.options.html || (o = e.posMax, e.src.charCodeAt(i) !== 60 || i + 2 >= o) || (r = e.src.charCodeAt(i + 1), r !== 33 && r !== 63 && r !== 47 && !uG(r)) || (s = e.src.slice(i).match(iG), !s) ? !1 : (n || (c = e.push("html_inline", "", 0), c.content = s[0], aG(c.content) && e.linkLevel++, lG(c.content) && e.linkLevel--), e.pos += s[0].length, !0);
}, Oc = da, hG = le.has, pG = le.isValidEntityCode, qc = le.fromCodePoint, dG = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, gG = /^&([a-z][a-z0-9]{1,31});/i, mG = function(e, n) {
  var r, s, o, c, i = e.pos, a = e.posMax;
  if (e.src.charCodeAt(i) !== 38 || i + 1 >= a)
    return !1;
  if (r = e.src.charCodeAt(i + 1), r === 35) {
    if (o = e.src.slice(i).match(dG), o)
      return n || (s = o[1][0].toLowerCase() === "x" ? parseInt(o[1].slice(1), 16) : parseInt(o[1], 10), c = e.push("text_special", "", 0), c.content = pG(s) ? qc(s) : qc(65533), c.markup = o[0], c.info = "entity"), e.pos += o[0].length, !0;
  } else if (o = e.src.slice(i).match(gG), o && hG(Oc, o[1]))
    return n || (c = e.push("text_special", "", 0), c.content = Oc[o[1]], c.markup = o[0], c.info = "entity"), e.pos += o[0].length, !0;
  return !1;
};
function Fc(t) {
...
var _G = function(e) {
  var n, r = e.tokens_meta, s = e.tokens_meta.length;
  for (Fc(e.delimiters), n = 0; n < s; n++)
    r[n] && r[n].delimiters && Fc(r[n].delimiters);
}, bG = function(e) {
  ...
  n !== r && (o.length = r);
}, io = so, Bc = le.isWhiteSpace, Pc = le.isPunctChar, $c = le.isMdAsciiPunct;
function Ln(t, e, n, r) {
...
Ln.prototype.scanDelims = function(t, e) {
  ...
  for (r = t > 0 ? this.src.charCodeAt(t - 1) : 32; n < m && this.src.charCodeAt(n) === _; )
    n++;
  return o = n - t, s = n < m ? this.src.charCodeAt(n) : 32, l = $c(r) || Pc(String.fromCharCode(r)), f = $c(s) || Pc(String.fromCharCode(s)), a = Bc(r), u = Bc(s), u ? h = !1 : f && (a || l || (h = !1)), a ? d = !1 : l && (u || f || (d = !1)), e ? (c = h, i = d) : (c = h && (!d || l), i = d && (!h || f)), {
    can_open: c,
    can_close: i,
    length: o
  };
};
Ln.prototype.Token = io;
var vG = Ln, zc = ro, os = [
  ["text", j5],
  ["linkify", Z5],
  ["newline", J5],
...
function Nn() {
  var t;
  for (this.ruler = new zc(), t = 0; t < os.length; t++)
    this.ruler.push(os[t][0], os[t][1]);
  for (this.ruler2 = new zc(), t = 0; t < cs.length; t++)
    this.ruler2.push(cs[t][0], cs[t][1]);
}
...
Nn.prototype.State = vG;
var yG = Nn, is, Uc;
function xG() {
  return Uc || (Uc = 1, is = function(t) {
    var e = {};
    t = t || {}, e.src_Any = ga().source, e.src_Cc = ma().source, e.src_Z = _a().source, e.src_P = no.source, e.src_ZPCc = [e.src_Z, e.src_P, e.src_Cc].join("|"), e.src_ZCc = [e.src_Z, e.src_Cc].join("|");
    var n = "[><｜]";
...
function fr(t) {
  var e = t.re = xG()(t.__opts__), n = t.__tlds__.slice();
  t.onCompile(), t.__tlds_replaced__ || n.push(TG), n.push(e.src_xn), e.src_tlds = n.join("|");
  function r(i) {
  ...
  Object.keys(t.__schemas__).forEach(function(i) {
    ...
    if (a !== null) {
      ...
      if (t.__compiled__[i] = l, kG(a)) {
        wG(a.validate) ? l.validate = LG(a.validate) : Hc(a.validate) ? l.validate = a.validate : o(i, a), Hc(a.normalize) ? l.normalize = a.normalize : a.normalize ? o(i, a) : l.normalize = Vc();
        return;
      }
      if (EG(a)) {
        s.push(i);
...
function Be(t, e) {
  if (!(this instanceof Be))
    return new Be(t, e);
  e || CG(t) && (e = t, t = {}), this.__opts__ = As({}, wa, e), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = As({}, SG, t), this.__compiled__ = {}, this.__tlds__ = DG, this.__tlds_replaced__ = !1, this.re = {}, fr(this);
}
Be.prototype.add = function(e, n) {
  return this.__schemas__[e] = n, fr(this), this;
};
...
Be.prototype.tlds = function(e, n) {
  return e = Array.isArray(e) ? e : [e], n ? (this.__tlds__ = this.__tlds__.concat(e).sort().filter(function(r, s, o) {
    return r !== o[s - 1];
  }).reverse(), fr(this), this) : (this.__tlds__ = e.slice(), this.__tlds_replaced__ = !0, fr(this), this);
};
...
var IG = Be;
const Yt = 2147483647, Ye = 36, ao = 1, Sn = 26, MG = 38, OG = 700, Aa = 72, Ca = 128, Sa = "-", qG = /^xn--/, FG = /[^\0-\x7F]/, BG = /[\x2E\u3002\uFF0E\uFF61]/g, PG = {
  overflow: "Overflow: input needs wider integers to process",
  "not-basic": "Illegal input >= 0x80 (not a basic code point)",
  "invalid-input": "Invalid input"
}, as = Ye - ao, Xe = Math.floor, ls = String.fromCharCode;
function pt(t) {
  throw new RangeError(PG[t]);
}
function $G(t, e) {
  const n = [];
  let r = t.length;
...
function Ta(t, e) {
  const n = t.split("@");
  let r = "";
  n.length > 1 && (r = n[0] + "@", t = n[1]), t = t.replace(BG, ".");
  const s = t.split("."), o = $G(s, e).join(".");
  return r + o;
}
function lo(t) {
  const e = [];
...
const Da = (t) => String.fromCodePoint(...t), zG = function(t) {
  return t >= 48 && t < 58 ? 26 + (t - 48) : t >= 65 && t < 91 ? t - 65 : t >= 97 && t < 123 ? t - 97 : Ye;
}, Gc = function(t, e) {
  return t + 22 + 75 * (t < 26) - ((e != 0) << 5);
}, Ra = function(t, e, n) {
  let r = 0;
  for (t = n ? Xe(t / OG) : t >> 1, t += Xe(t / e); t > as * Sn >> 1; r += Ye)
    t = Xe(t / as);
  return Xe(r + (as + 1) * t / (t + MG));
}, uo = function(t) {
  const e = [], n = t.length;
  let r = 0, s = Ca, o = Aa, c = t.lastIndexOf(Sa);
  c < 0 && (c = 0);
  for (let i = 0; i < c; ++i)
  ...
  for (let i = c > 0 ? c + 1 : 0; i < n; ) {
    ...
    for (let u = 1, f = Ye; ; f += Ye) {
      ...
      const h = zG(t.charCodeAt(i++));
      h >= Ye && pt("invalid-input"), h > Xe((Yt - r) / u) && pt("overflow"), r += h * u;
      const d = f <= o ? ao : f >= o + Sn ? Sn : f - o;
      if (h < d)
        break;
      const m = Ye - d;
    ...
    const l = e.length + 1;
    o = Ra(r - a, l, a == 0), Xe(r / l) > Yt - s && pt("overflow"), s += Xe(r / l), r %= l, e.splice(r++, 0, s);
  }
  ...
  for (c && e.push(Sa); i < n; ) {
    ...
    for (const u of t)
      if (u < r && ++s > Yt && pt("overflow"), u === r) {
        ...
        e.push(ls(Gc(f, 0))), o = Ra(s, l, i === c), s = 0, ++i;
      }
    ++s, ++r;
  }
  return e.join("");
  ...
  return Ta(t, function(e) {
    return qG.test(e) ? uo(e.slice(4).toLowerCase()) : e;
  });
}, Na = function(t) {
  return Ta(t, function(e) {
    return FG.test(e) ? "xn--" + fo(e) : e;
  });
}, UG = {
  /**
  ...
  ucs2decode: lo,
  ucs2encode: Da
}, Symbol.toStringTag, { value: "Module" })), VG = /* @__PURE__ */ Df(HG);
var GG = {
  options: {
    html: !1,
...
}, bn = le, ZG = Lr, WG = z8, JG = f5, YG = V5, XG = yG, QG = IG, Lt = rn, Ia = VG, ej = {
  default: GG,
  zero: jG,
  commonmark: KG
}, tj = /^(vbscript|javascript|file|data):/, nj = /^data:image\/(gif|png|jpeg|webp);/;
function rj(t) {
  var e = t.trim().toLowerCase();
  return tj.test(e) ? !!nj.test(e) : !0;
}
var Ma = ["http:", "https:", "mailto:"];
function sj(t) {
  var e = Lt.parse(t, !0);
  if (e.hostname && (!e.protocol || Ma.indexOf(e.protocol) >= 0))
    try {
      e.hostname = Ia.toASCII(e.hostname);
    } catch {
    }
...
function oj(t) {
  ...
  if (e.hostname && (!e.protocol || Ma.indexOf(e.protocol) >= 0))
    try {
      e.hostname = Ia.toUnicode(e.hostname);
    } catch {
    }
...
function He(t, e) {
  if (!(this instanceof He))
    return new He(t, e);
  e || bn.isString(t) || (e = t || {}, t = "default"), this.inline = new XG(), this.block = new YG(), this.core = new JG(), this.renderer = new WG(), this.linkify = new QG(), this.validateLink = rj, this.normalizeLink = sj, this.normalizeLinkText = oj, this.utils = bn, this.helpers = bn.assign({}, ZG), this.options = {}, this.configure(t), e && this.set(e);
}
...
var cj = He, ij = cj;
const aj = /* @__PURE__ */ Js(ij), lj = /* @__PURE__ */ Ve({
  name: "VueMarkdown",
  props: {
    source: {
      type: String,
  ...
  setup(t) {
    const e = Le(new aj(t.options ?? {}));
    for (const r of t.plugins ?? [])
      e.value.use(r);
    const n = Re(() => e.value.render(t.source));
    return () => ji("div", { innerHTML: n.value });
  }
}), hr = "[A-Za-z$_][0-9A-Za-z$_]*", Oa = [
  "as",
  // for exports
  "in",
  "of",
...
function Ua(t, e) {
  ...
  t.renderer.rules.link_open = function(r, s, o, c, i) {
    var a = dj(r[s], e), l = a && a.attrs;
    return l && gj(s, r, l), n(r, s, o, c, i);
  };
}
Ua.defaultRender = function(t, e, n, r, s) {
  return s.renderToken(t, e, n);
};
var mj = Ua;
const _j = /* @__PURE__ */ Js(mj), bj = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, vj = /* @__PURE__ */ he("path", {
...
function xj(t, e) {
  return Z(), ce("svg", bj, [...yj]);
}
const jc = { name: "mdi-fileText", render: xj }, Ej = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, kj = /* @__PURE__ */ he("path", {
...
function Aj(t, e) {
  return Z(), ce("svg", Ej, [...wj]);
}
const Cj = { name: "mdi-fileMusic", render: Aj }, Sj = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, Tj = /* @__PURE__ */ he("path", {
...
function Rj(t, e) {
  return Z(), ce("svg", Sj, [...Dj]);
}
const Lj = { name: "mdi-fileImage", render: Rj }, Nj = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, Ij = /* @__PURE__ */ he("path", {
...
function Oj(t, e) {
  return Z(), ce("svg", Nj, [...Mj]);
}
const qj = { name: "mdi-fileVideo", render: Oj }, Fj = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, Bj = /* @__PURE__ */ he("path", {
...
function $j(t, e) {
  return Z(), ce("svg", Fj, [...Pj]);
}
const zj = { name: "mdi-closeThick", render: $j }, Uj = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, Hj = /* @__PURE__ */ he("path", {
...
function Gj(t, e) {
  return Z(), ce("svg", Uj, [...Vj]);
}
const jj = { name: "mdi-openInNew", render: Gj }, Kj = { class: "chat-file-name" }, Zj = /* @__PURE__ */ Ve({
  __name: "ChatFile",
  props: {
    file: {},
  ...
  setup(t, { emit: e }) {
    ...
    return (i, a) => (Z(), ce("div", {
      ...
      ge(se(o)),
      he("p", Kj, vn(i.file.name), 1),
      i.isRemovable ? (Z(), be(se(zj), {
        key: 0,
        class: "chat-file-delete"
      })) : Fe("", !0),
      i.isPreviewable ? (Z(), be(se(jj), {
        key: 1,
        class: "chat-file-preview"
      })) : Fe("", !0)
    ]));
  }
}), Ha = /* @__PURE__ */ Sr(Zj, [["__scopeId", "data-v-4da5a5e1"]]), Wj = {
  key: 0,
  ...
  setup(t, { expose: e }) {
    const n = t;
    nt.registerLanguage("javascript", fa), nt.registerLanguage("typescript", fj), nt.registerLanguage("python", hj), nt.registerLanguage("xml", ia), nt.registerLanguage("bash", pj);
    const { message: r } = Il(n), { options: s } = Rn(), o = Le(null), c = Le({}), i = Re(() => r.value.text || "&lt;Empty response&gt;"), a = Re(() => ({
    ...
    return vt(async () => {
      ...
      m.$slots.beforeMessage ? (Z(), ce("div", Wj, [
        Mt(m.$slots, "beforeMessage", hs(Ks({ message: se(r) })))
      ])) : Fe("", !0),
      Mt(m.$slots, "default", {}, () => [
        se(r).type === "component" && h[se(r).key] ? (Z(), be(Kl(h[se(r).key]), hs(Hi({ key: 0 }, se(r).arguments)), null, 16)) : (Z(), be(se(lj), {
          key: 1,
        ...
        (se(r).files ?? []).length > 0 ? (Z(), ce("div", Jj, [
...
}), Yj = /* @__PURE__ */ he("div", { class: "chat-message-typing-body" }, [
...
}), Qj = { class: "chat-messages-list" }, e7 = /* @__PURE__ */ Ve({
  __name: "MessagesList",
  props: {
    messages: {}
  },
  setup(t) {
    const e = to(), n = Le([]), { initialMessages: r, waitingForResponse: s } = e;
    return Jn(
      () => n.value.length,
      () => {
...
function s7(t, e) {
  return Z(), ce("svg", t7, [...r7]);
}
const o7 = { name: "mdi-send", render: s7 }, c7 = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, i7 = /* @__PURE__ */ he("path", {
...
function l7(t, e) {
  return Z(), ce("svg", c7, [...a7]);
}
const u7 = { name: "mdi-filePlus", render: l7 };
function f7(t) {
  return ei() ? (il(t), !0) : !1;
}
function h7() {
...
const p7 = typeof window < "u" && typeof document < "u";
typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope;
const d7 = (t, e) => Object.prototype.hasOwnProperty.call(t, e), g7 = p7 ? window.document : void 0, m7 = {
  multiple: !0,
  accept: "*",
  reset: !1,
  directory: !1
...
function _7(t = {}) {
  ...
  const c = () => {
    ...
    o.multiple = l.multiple, o.accept = l.accept, o.webkitdirectory = l.directory, d7(l, "capture") && (o.capture = l.capture), l.reset && c(), o.click();
  };
  return {
    files: Bs(n),
    open: i,
...
const b7 = { class: "chat-inputs" }, v7 = ["disabled", "placeholder"], y7 = { class: "chat-inputs-controls" }, x7 = ["disabled"], E7 = ["disabled"], k7 = {
  key: 0,
  class: "chat-files"
}, w7 = /* @__PURE__ */ Ve({
  __name: "Input",
  emits: ["arrowKeyDown"],
  setup(t, { emit: e }) {
    const n = e, { options: r } = Rn(), s = to(), { waitingForResponse: o } = s, { t: c } = Tr(), i = Le(null), a = Le(null), l = Le(""), u = Le(!1), f = Re(() => {
      var L;
    ...
    return (L, ee) => {
      ...
      return Z(), ce("div", {
        ...
        (A = i.value) != null && A.length && !u.value ? (Z(), ce("div", k7, [
          (Z(!0), ce(Ae, null, rr(i.value, (K) => (Z(), be(Ha, {
            key: K.name,
            file: K,
            "is-removable": !0,
            onRemove: Q
...
}), A7 = /* @__PURE__ */ Sr(w7, [["__scopeId", "data-v-abe260b1"]]), C7 = { class: "chat-heading" }, S7 = ["title"], T7 = { key: 0 }, Va = /* @__PURE__ */ Ve({
  __name: "Chat",
  setup(t) {
    const { t: e } = Tr(), n = to(), { messages: r, currentSessionId: s } = n, { options: o } = Rn(), c = Re(() => o.mode === "window" && o.showWindowCloseButton);
    async function i() {
    ...
    }), (u, f) => (Z(), be(zh, { class: "chat-wrapper" }, {
      header: st(() => [
        he("div", C7, [
        ...
        se(e)("subtitle") ? (Z(), ce("p", T7, vn(se(e)("subtitle")), 1)) : Fe("", !0)
      ]),
      footer: st(() => [
        se(s) ? (Z(), be(A7, { key: 0 })) : (Z(), be(Qh, { key: 1 }))
      ]),
      default: st(() => [
        !se(s) && se(o).showWelcomeScreen ? (Z(), be(Gh, {
          key: 0,
          "onClick:button": i
        })) : (Z(), be(e7, {
          key: 1,
...
function N7(t, e) {
  return Z(), ce("svg", D7, [...L7]);
}
const I7 = { name: "mdi-chat", render: N7 }, M7 = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
}, O7 = /* @__PURE__ */ he("path", {
...
function F7(t, e) {
  return Z(), ce("svg", M7, [...q7]);
}
const B7 = { name: "mdi-chevron-down", render: F7 }, P7 = { class: "chat-window-wrapper" }, $7 = { class: "chat-window" }, z7 = /* @__PURE__ */ Ve({
  __name: "ChatWindow",
  setup(t) {
    const e = Le(!1);
    function n() {
  ...
  setup(t) {
    ...
    return vt(() => {
      nt.registerLanguage("xml", ia), nt.registerLanguage("javascript", fa);
    }), (r, s) => n.value ? (Z(), be(se(Va), {
      key: 0,
      class: "n8n-chat"
    })) : (Z(), be(se(z7), {
      key: 1,
...
const G7 = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function j7(t) {
  return typeof t == "string" && G7.test(t);
}
var Ee = [];
for (var us = 0; us < 256; ++us)
  Ee.push((us + 256).toString(16).substr(1));
function K7(t) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, n = (Ee[t[e + 0]] + Ee[t[e + 1]] + Ee[t[e + 2]] + Ee[t[e + 3]] + "-" + Ee[t[e + 4]] + Ee[t[e + 5]] + "-" + Ee[t[e + 6]] + Ee[t[e + 7]] + "-" + Ee[t[e + 8]] + Ee[t[e + 9]] + "-" + Ee[t[e + 10]] + Ee[t[e + 11]] + Ee[t[e + 12]] + Ee[t[e + 13]] + Ee[t[e + 14]] + Ee[t[e + 15]]).toLowerCase();
  if (!j7(n))
...
async function ho(...t) {
  var o, c;
  const e = await Z7(), n = (o = t[1]) == null ? void 0 : o.body, r = {
...
async function Ga(t, e = {}, n = {}) {
  ...
  return Object.keys(e).length > 0 && (r = `${r}?${new URLSearchParams(
    e
  ).toString()}`), await ho(r, { ...n, method: "GET" });
}
...
async function J7(t, e) {
  var r, s;
  return await (((r = e.webhookConfig) == null ? void 0 : r.method) === "POST" ? ja : Ga)(
    `${e.webhookUrl}`,
    {
...
async function Y7(t, e, n, r) {
  ...
  ) : await (((c = r.webhookConfig) == null ? void 0 : c.method) === "POST" ? ja : Ga)(
    `${r.webhookUrl}`,
    {
      action: "sendMessage",
      [r.chatSessionKey]: n,
  ...
  install(t, e) {
    ...
    async function i() {
      if (!e.loadPreviousSession)
        return;
      const u = localStorage.getItem(lc) ?? fn(), f = await J7(u, e), h = (/* @__PURE__ */ new Date()).toISOString();
    ...
    async function a() {
      r.value = fn(), localStorage.setItem(lc, r.value);
    }
    const l = {
      initialMessages: o,
      messages: n,
    ...
    t.provide(ha, l), t.config.globalProperties.$chat = l;
  }
};
function Q7(t) {
  var s, o;
  ...
  typeof n == "string" && Fh(n);
  const r = Cf(U7);
  return r.use(X7, e), r.mount(n), r;
}
export {
  Q7 as createChat
};
